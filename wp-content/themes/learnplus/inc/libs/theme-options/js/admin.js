	...
	alien = {
		...
		save: function () {
			alien.$wrap.on( 'click', '.save-options', function ( e ) {
				...
				$.post( ajaxurl, {
					action     : 'trending_template_options_save',
		...
		reset: function () {
			alien.$wrap.on( 'click', '.reset-options', function ( e ) {
				...
				$.post( ajaxurl, {
					'action'     : 'trending_template_options_reset',
		...
		restore: function () {
			alien.$wrap.on( 'click', '.import-options', function ( e ) {
				...
				$.post( ajaxurl, {
					action     : 'trending_template_options_import',
					data       : data,
        ...
        generateCSS: function () {
            $.post( ajaxurl, {
                action     : 'trending_template_generate_custom_css',
