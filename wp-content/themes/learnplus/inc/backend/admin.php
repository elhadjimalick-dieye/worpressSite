...
function learnplus_login_scripts() {
	...
	$logo = $logo ? $logo : get_template_directory_uri() . '/img/login-logo.png';
	?>
	<style type="text/css">
		.login h1 a {
	...
	<?php
	wp_enqueue_style( 'learnplus-login', get_template_directory_uri() . '/css/login.css', array(), '20160712' );
	wp_enqueue_script( 'learnplus-login', get_template_directory_uri() . '/js/login.js', array( 'jquery' ), '20160712' );
}
