...
class LearnPlus_Walker_Nav_Menu_Custom_Fields {
	...
	public function enqueue_scripts( $hook ) {
		...
		wp_enqueue_style( 'learnplus-nav-menus', get_template_directory_uri() . '/css/backend/nav-menus.css', array(), '20160712' );
		wp_enqueue_script( 'learnplus-nav-menus', get_template_directory_uri() . '/js/backend/nav-menus.js', array(), '20160712' );
		wp_localize_script(
	...
	public function learnplus_mega_fields() {
		...
		<div class="field-mega-menu item-mega-color field-of-mega-menu">
			...
			<span><?php esc_html_e( 'White', 'learnplus' ); ?></span>
		</div>
		<div class="clear"></div>
