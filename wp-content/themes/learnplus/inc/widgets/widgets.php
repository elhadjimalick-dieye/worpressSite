...
require_once get_template_directory() . '/inc/widgets/contact.php';
require_once get_template_directory() . '/inc/widgets/course.php';
require_once get_template_directory() . '/inc/widgets/login.php';
