...
class LearnPlus_WooCommerce {
	...
	function product_stock_html( $availability_html, $availability, $product ) {
		...
		$availability_html = empty( $availability['availability'] ) ? '' : '<p class="stock ' . esc_attr( $availability['class'] ) . '">' . esc_html__( 'Availability: ', 'learnplus' )  . '<span>' . esc_html( $availability['availability'] ) . '</span>' . '</p>';
