		...
		<div class="course-description">
			...
			if ( $show_content ) {
				...
				if ( $attempts_left ) {
					...
					?>
					<p id="learndash_already_taken"><?php echo sprintf( esc_html__( 'You have already taken this quiz %d times and may not take it again.', 'learnplus' ), $attempts_count ); ?></p>
					<?php
				}
			}
			?>
