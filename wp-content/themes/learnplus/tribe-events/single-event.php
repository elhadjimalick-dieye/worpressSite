...
<div id="tribe-events-content" class="tribe-events-single vevent hentry">
	...
	<p class="tribe-events-back">
		<a href="<?php echo esc_url( tribe_get_events_link() ); ?>"> <?php printf( esc_html__( '&laquo; All %s', 'learnplus' ), $events_label_plural ); ?></a>
	</p>
	...
	<div id="tribe-events-header" <?php tribe_events_the_header_attributes() ?>>
		<!-- Navigation -->
		<h3 class="tribe-events-visuallyhidden"><?php printf( esc_html__( '%s Navigation', 'learnplus' ), $events_label_singular ); ?></h3>
