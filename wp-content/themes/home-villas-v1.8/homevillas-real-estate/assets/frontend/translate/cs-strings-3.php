...
if ( ! class_exists('wp_rem_cs_theme_all_strings_3') ) {
    ...
    class wp_rem_cs_theme_all_strings_3 {
        ...
        public function wp_rem_cs_theme_strings_callback($wp_rem_cs_var_static_text) {
            ...
            $wp_rem_cs_var_static_text['wp_rem_cs_var_edit_newsletter_styles_fancy'] = esc_html__('Fancy', 'homevillas-real-estate');
            ...
            $wp_rem_cs_var_static_text['wp_rem_cs_var_theme_option_footer_social_icon_switch'] = esc_html__('Footer Social Icons', 'homevillas-real-estate');
            ...
            $wp_rem_cs_var_static_text['wp_rem_cs_var_footer_border_color'] = esc_html__('Footer Border Color', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_footer_border_color_hint'] = esc_html__('Change footer border color', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_widget_recent_post_length'] = esc_html__('Post Tile Length', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_element_price_table_element_title_color'] = esc_html__('Element Title Color', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_var_widget_contact_fax'] = esc_html__('Fax', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_element_title_color'] = esc_html__('Element Title Color', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_element_title_color_hint'] = esc_html__('Set the element title color here', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_element_subtitle_color'] = esc_html__('Element Subtitle Color', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_element_subtitle_color_hint'] = esc_html__('Set the element subtitle color here', 'homevillas-real-estate');
            
            $wp_rem_cs_var_static_text['wp_rem_header_full_width_hint'] = esc_html__('Turn this switch on/off for header wide/boxed', 'homevillas-real-estate');
            
            
            
            
            
            $wp_rem_cs_var_static_text['wp_rem_cs_var_element_title_seperator'] = esc_html__('Seperator', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_element_title_seperator_hint'] = esc_html__('Set the element title seperator here.', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_element_title_seperator_none'] = esc_html__('None', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_element_title_seperator_classic'] = esc_html__('Classic Seperator', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_element_title_seperator_zigzag'] = esc_html__('Zigzag Seperator', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_widget_cache_time_limit'] = esc_html__('Cache Time Limit', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_widget_cache_time_limit_hint'] = esc_html__('Add time limit in minutes for refresh cache', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_widget_date_time_format'] = esc_html__('Date Time Format', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_widget_date_time_format_hint'] = esc_html__('Select date time format for every tweet.', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_theme_skin'] = esc_html__('Theme Skins', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_theme_skin_hint'] = esc_html__('Choose theme skin default/dark from dropdown', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_theme_skin_default'] = esc_html__('Default', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_theme_skin_dark'] = esc_html__('Dark', 'homevillas-real-estate');
