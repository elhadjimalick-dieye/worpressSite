...
if ( ! class_exists('wp_rem_cs_theme_all_strings_2') ) {
    ...
    class wp_rem_cs_theme_all_strings_2 {
        ...
        public function wp_rem_cs_plugin_activation_strings_callback($wp_rem_cs_var_static_text) {
			...
			$wp_rem_cs_var_static_text['wp_rem_cs_var_config_download_import_attachments'] = esc_html__('To download import attachments this option is required.', 'homevillas-real-estate');
			...
			$wp_rem_cs_var_static_text['wp_rem_cs_var_config_icons_manager_title'] = esc_html__('CS Icons Manager', 'homevillas-real-estate');
            $wp_rem_cs_var_static_text['wp_rem_cs_var_config_icons_manager_desc'] = esc_html__('This plugin is required as this handles all functionality related to cs icons manager etc.', 'homevillas-real-estate');
