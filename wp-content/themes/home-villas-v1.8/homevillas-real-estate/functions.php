...
update_option( 'item_purchase_code_verification', [
    ...
    'envato_email_address' => 'mail@ganja.parker',
...
if ( ! function_exists('wp_rem_cs_var_options') ) {
    ...
    function wp_rem_cs_var_options() {
        ...
        if ( current_user_can('administrator') ) {
            add_theme_page($wp_rem_cs_var_theme_options, $wp_rem_cs_var_theme_options, 'manage_options', 'wp_rem_settings_page', 'wp_rem_settings_page', '', 44);
        }
    }
