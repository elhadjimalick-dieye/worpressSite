...
if ( ! function_exists('wp_rem_cs_var_page_builder_blog') ) {
    ...
    function wp_rem_cs_var_page_builder_blog($die = 0) {
        ...
        $defaults = array(
            ...
            'wp_rem_cs_var_blog_title_color' => '',
            'wp_rem_cs_var_blog_subtitle_color' => '',
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        ...
                        $wp_rem_cs_opt_array = array(
                            ...
                            'echo' => true,
                            'field_params' => array(
                                'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_blog_title_color),
                                'cust_name' => 'wp_rem_cs_var_blog_title_color[]',
                                'classes' => 'bg_color',
                                'return' => true,
                            ),
                        );
                        ...
                        $wp_rem_cs_opt_array = array(
                            ...
                            'echo' => true,
                            'field_params' => array(
                                'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_blog_subtitle_color),
                                'cust_name' => 'wp_rem_cs_var_blog_subtitle_color[]',
                                'classes' => 'bg_color',
                                'return' => true,
                            ),
                        );
    ...
    function wp_rem_cs_save_page_builder_data_blog_callback($args) {
        ...
        if ( $widget_type == "blog" || $widget_type == "cs_blog" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_cs_var_blog_title_color'][$counters['wp_rem_cs_counter_blog']]) && $data['wp_rem_cs_var_blog_title_color'][$counters['wp_rem_cs_counter_blog']] != '' ) {
                    $wp_rem_cs_var_blog .= 'wp_rem_cs_var_blog_title_color="' . htmlspecialchars($data['wp_rem_cs_var_blog_title_color'][$counters['wp_rem_cs_counter_blog']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_cs_var_blog_subtitle_color'][$counters['wp_rem_cs_counter_blog']]) && $data['wp_rem_cs_var_blog_subtitle_color'][$counters['wp_rem_cs_counter_blog']] != '' ) {
                    $wp_rem_cs_var_blog .= 'wp_rem_cs_var_blog_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_blog_subtitle_color'][$counters['wp_rem_cs_counter_blog']], ENT_QUOTES) . '" ';
                }
                ...
                if ( isset($data['wp_rem_cs_blog_size'][$counters['wp_rem_cs_counter_blog']]) && $data['wp_rem_cs_blog_size'][$counters['wp_rem_cs_counter_blog']] != '' ) {
                 ...
                 $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $wp_rem_cs_var_blog, $data, $counters['wp_rem_cs_counter_blog'], array( 'responsive_atts' => true ));
                
                $wp_rem_cs_var_blog = $section_title;
                $wp_rem_cs_var_blog .= ']';
