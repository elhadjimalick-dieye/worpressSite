...
if ( ! function_exists('wp_rem_cs_blog_shortcode') ) {
    ...
    function wp_rem_cs_blog_shortcode($atts) {
        ...
        if( isset($post) && !is_array( $post ) && is_numeric($post)){
			$wp_rem_cs_dataObject = get_post_meta($post, 'wp_rem_cs_full_data');
		}else{
        ...
        $section_title .= wp_rem_title_sub_align($wp_rem_cs_blog_element_title, $wp_rem_cs_blog_element_subtitle, $wp_rem_cs_blog_element_title_alignment,$wp_rem_cs_var_blog_title_color, $seperator,$wp_rem_cs_var_blog_subtitle_color);
