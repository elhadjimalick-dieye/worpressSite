                                                ...
                                                <div class="text-holder">
                                                    ...
                                                    <div class="icons-list">
                                                        ...
                                                        if ( 'true' === wp_rem_get_cookie('wp_rem_post_like_counter' . $post->ID) ) {
                                                            ...
                                                            ?>
                                                            <span>
                                                                <a  id="post_likes<?php echo esc_html($post->ID); ?>" onclick="wp_rem_post_likes_count_theme('<?php echo esc_url(admin_url('admin-ajax.php')); ?>', '<?php echo esc_html($post->ID) ?>', 'blog_views', this)"><i class="icon-heart-outlined"></i></a>
                                                            </span>
                                                        <?php } ?>
