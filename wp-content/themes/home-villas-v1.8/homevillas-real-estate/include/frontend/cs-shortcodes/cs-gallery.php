...
if ( ! function_exists('wp_rem_cs_gallery_shortcode') ) {
    ...
    'wp_rem_cs_var_gallery_subtitle_color'=>'',
        ...
        $html .= wp_rem_title_sub_align($wp_rem_cs_var_gallery_main_title, $wp_rem_cs_var_gallery_main_subtitle, $wp_rem_var_gallery_align,$wp_rem_cs_var_gallery_title_color,$wp_rem_var_gallery_seperator_style,$wp_rem_cs_var_gallery_subtitle_color);
	...
	wp_rem_gallery_masonry();
        ...
        return '<div class="' . wp_rem_cs_var_page_builder_element_sizes($page_element_size,$atts) . ' ">' . do_shortcode($html) . '</div>';
    }
...
if ( ! function_exists('wp_rem_cs_gallery_item_shortcode') ) {
    ...
    function wp_rem_cs_gallery_item_shortcode($atts, $content = "") {
        ...
        $html .= '<li class="' . esc_html($wp_rem_cs_var_galler_img_size) . '">'
                . '<a href="' . esc_url($wp_rem_cs_var_gallery_image) . '" data-rel="prettyPhoto['.$acc_counter.']">'
