...
if ( ! function_exists('wp_rem_cs_var_list_shortcode') ) {
    ...
    function wp_rem_cs_var_list_shortcode($atts, $content = "") {
        ...
        $wp_rem_cs_section_title .= wp_rem_title_sub_align($wp_rem_cs_var_list_title, $wp_rem_cs_var_list_sub_title, $wp_rem_var_list_align,$wp_rem_cs_var_list_title_color,$wp_rem_var_list_seperator_style,$wp_rem_cs_var_list_subtitle_color);
