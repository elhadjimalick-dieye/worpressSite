...
if ( ! function_exists('wp_rem_cs_var_call_to_action_shortcode') ) {
    ...
    function wp_rem_cs_var_call_to_action_shortcode($atts, $content = "") {
        ...
        $wp_rem_var_call_to_action_seperator_style = isset($wp_rem_var_call_to_action_seperator_style) ? $wp_rem_var_call_to_action_seperator_style : '';
        ...
        $html .= wp_rem_title_sub_align($wp_rem_cs_var_call_to_action_title, $wp_rem_cs_var_call_to_action_subtitle, $wp_rem_var_call_to_action_align,$wp_rem_cs_var_call_to_action_title_color,$wp_rem_var_call_to_action_seperator_style,$wp_rem_cs_var_call_to_action_subtitle_color);
