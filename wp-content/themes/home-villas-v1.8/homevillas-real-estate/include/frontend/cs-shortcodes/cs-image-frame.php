...
if ( ! function_exists('wp_rem_cs_var_image_frame') ) {
    ...
    function wp_rem_cs_var_image_frame($atts, $content = "") {
        ...
        if ( function_exists('wp_rem_cs_var_page_builder_element_sizes') ) {
            $wp_rem_cs_var_image_frame .= '<div class="' . wp_rem_cs_var_page_builder_element_sizes($page_element_size,$atts) .$col_respons_class. ' ">';
        }
        ...
        $wp_rem_cs_var_image_frame .= wp_rem_title_sub_align($wp_rem_cs_var_image_section_title, $wp_rem_cs_var_image_section_subtitle, $wp_rem_var_image_title_align,$wp_rem_cs_var_image_frame_title_color,$wp_rem_var_image_frame_seperator_style,$wp_rem_cs_var_image_frame_subtitle_color);
        if ( $wp_rem_cs_var_img_style != 'modern' ) {
