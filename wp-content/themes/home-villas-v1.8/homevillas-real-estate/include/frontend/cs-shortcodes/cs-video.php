...
if ( ! function_exists( 'wp_rem_cs_var_video' ) ) {
	...
	function wp_rem_cs_var_video( $atts, $content = "" ) {
		...
		if ( function_exists( 'wp_rem_cs_var_page_builder_element_sizes' ) ) {
			$video .= '<div class="' . wp_rem_cs_var_page_builder_element_sizes( $page_element_size,$atts) . ' ">';
		}
		$defaults = array(
    ...
    'wp_rem_cs_var_video_subtitle_color'=>'',
		...
		$video .= wp_rem_title_sub_align( $wp_rem_cs_var_video_title, $wp_rem_cs_var_video_subtitle,$wp_rem_var_video_align,$wp_rem_cs_var_video_title_color,$wp_rem_var_video_seperator_style,$wp_rem_cs_var_video_subtitle_color);
