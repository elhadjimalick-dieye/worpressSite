...
if ( ! function_exists('wp_rem_cs_var_infobox_shortcode') ) {
    ...
    function wp_rem_cs_var_infobox_shortcode($atts, $content = "") {
        ...
        if ( $wp_rem_var_infobox_styles == 'modern' ) {
            ...
            $html .= wp_rem_title_sub_align($wp_rem_cs_var_infobox_main_title, $wp_rem_cs_var_infobox_main_subtitle, $wp_rem_var_infobox_align,$wp_rem_cs_var_info_heading_color,$wp_rem_var_infobox_seperator_style,$wp_rem_cs_var_infobox_subtitle_color);
            $html .='<div class="row">';
