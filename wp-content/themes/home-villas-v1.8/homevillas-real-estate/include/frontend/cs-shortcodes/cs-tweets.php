...
if ( ! function_exists('wp_rem_cs_var_tweets_shortcode') ) {
    ...
    function wp_rem_cs_var_tweets_shortcode($atts, $content = "") {
        ...
        $html .= wp_rem_title_sub_align($wp_rem_cs_var_tweet_title, $wp_rem_cs_var_tweet_subtitle, $wp_rem_var_tweet_align,$wp_rem_cs_var_tweets_title_color,$wp_rem_var_tweets_seperator_style,$wp_rem_cs_var_tweets_subtitle_color);
        $html .= '<div class="rem-twitter rem-tweet-slider" ' . $tweets_color . '>';
        $html .= '<span class="tweet-bg"><i class="icon-twitter2"></i></span>';
        $html .= '<div class="tweet-head">
                            <span><i class="icon-twitter2"></i>@<a target="_blank" href="https://twitter.com/' . $wp_rem_cs_var_tweets_user_name . '">' . $wp_rem_cs_var_tweets_user_name . '</a></span>
        ...
        $html .= '</div>'; // rem-twitter rem-twitter-class
