...
if ( ! function_exists('wp_rem_cs_price_table_shortcode') ) {
    ...
    function wp_rem_cs_price_table_shortcode($atts, $content = null) {
        ...
        if ( function_exists('wp_rem_cs_var_page_builder_element_sizes') ) {
            $wp_rem_cs_var_price_table .= '<div class="' . wp_rem_cs_var_page_builder_element_sizes($page_element_size,$atts) . ' ">';
        }
        $defaults = array(
        ...
        $wp_rem_cs_price_table_element_title_color = isset($wp_rem_cs_price_table_element_title_color) ? $wp_rem_cs_price_table_element_title_color : '';
        ...
        $wp_rem_cs_var_price_table .= wp_rem_title_sub_align($wp_rem_cs_multi_price_table_section_title, $wp_rem_cs_multi_price_table_section_subtitle, $wp_rem_var_price_table_align, $wp_rem_cs_price_table_element_title_color,$wp_rem_var_price_table_seperator_style,$wp_rem_cs_var_price_table_subtitle_color);
        ...
        if ( $wp_rem_cs_price_table_style == 'classic' ) {
            ...
            if ( isset($wp_rem_var_price_table_packages_list) && $wp_rem_var_price_table_packages_list != '' ) {
                ...
                if ( $wp_rem_cs_price_table_button_text <> '' ) {
                    $wp_rem_cs_var_price_table_item .= '<a  target="_blank" class="try-btn" style="background-color:' . force_balance_tags($wp_rem_cs_price_table_button_color_bg) . '!important; color:' . force_balance_tags($wp_rem_cs_price_table_button_color) . ' !important" href="' . esc_url($wp_rem_cs_price_table_button_link) . '">' . esc_html($wp_rem_cs_price_table_button_text) . '</a>';
                }
            }
            $wp_rem_cs_var_price_table_item .= '</div>';
            ...
            if ( isset($wp_rem_var_price_table_packages_list) && $wp_rem_var_price_table_packages_list != '' ) {
                ...
                if ( $wp_rem_cs_price_table_button_text <> '' ) {
                    $wp_rem_cs_var_price_table_item .= '<a target="_blank" class="try-btn" style="background-color:' . force_balance_tags($wp_rem_cs_price_table_button_color_bg) . '!important; color:' . force_balance_tags($wp_rem_cs_price_table_button_color) . ' !important" href="' . esc_url($wp_rem_cs_button_link) . '" >' . esc_html($wp_rem_cs_price_table_button_text) . '</a>';
                }
            }
            $wp_rem_cs_var_price_table_item .= '</div>';
            $wp_rem_cs_var_price_table_item .= do_shortcode($content);
