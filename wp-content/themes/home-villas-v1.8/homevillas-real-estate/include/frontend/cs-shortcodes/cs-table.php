...
if ( ! function_exists('wp_rem_cs_var_table_shortcode') ) {
    ...
    function wp_rem_cs_var_table_shortcode($atts, $content = "") {
        ...
        $html .= wp_rem_title_sub_align($wp_rem_cs_table_element_title, $wp_rem_cs_table_element_subtitle, $wp_rem_var_table_align, $wp_rem_cs_var_table_title_color, $wp_rem_var_table_seperator_style, $wp_rem_cs_var_table_subtitle_color);
