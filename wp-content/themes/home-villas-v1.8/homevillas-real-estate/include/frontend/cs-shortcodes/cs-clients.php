...
if ( ! function_exists('wp_rem_cs_clients_shortcode') ) {
    ...
    function wp_rem_cs_clients_shortcode($atts, $content = null) {
        ...
        if ( function_exists('wp_rem_cs_var_page_builder_element_sizes') ) {
            $wp_rem_cs_var_clients .= '<div class="' . wp_rem_cs_var_page_builder_element_sizes($page_element_size, $atts) . ' ">';
        }
        ...
        $wp_rem_var_clients_seperator_style = isset($wp_rem_var_clients_seperator_style) ? $wp_rem_var_clients_seperator_style : '';
        ...
        $wp_rem_cs_var_clients .= wp_rem_title_sub_align($wp_rem_cs_var_clients_element_title, $wp_rem_cs_var_clients_element_subtitle, $wp_rem_var_clients_align, $wp_rem_cs_var_clients_title_color, $wp_rem_var_clients_seperator_style, $wp_rem_cs_var_clients_subtitle_color);
        //}
