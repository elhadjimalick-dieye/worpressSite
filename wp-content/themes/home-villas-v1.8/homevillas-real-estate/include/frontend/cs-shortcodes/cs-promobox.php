...
if ( ! function_exists('wp_rem_cs_var_promobox') ) {
    ...
    function wp_rem_cs_var_promobox($atts, $content = "") {
        ...
        if ( function_exists('wp_rem_cs_var_page_builder_element_sizes') ) {
            $wp_rem_cs_var_promobox .= '<div class="' . wp_rem_cs_var_page_builder_element_sizes($page_element_size,$atts) . ' ">';
        }
        if ( isset($column_class) && $column_class <> '' ) {
            $wp_rem_cs_var_promobox .= '<div class="' . esc_html($column_class) . '">';
        }
        $wp_rem_cs_var_promobox .= wp_rem_title_sub_align($wp_rem_cs_var_image_section_title, $wp_rem_cs_var_image_section_subtitle, $wp_rem_var_promobox_align, $wp_rem_cs_var_promobox_title_color, $wp_rem_var_newsletter_seperator_style, $wp_rem_cs_var_promobox_subtitle_color);
