...
if ( ! function_exists('wp_rem_cs_counters_shortcode') ) {
    ...
    function wp_rem_cs_counters_shortcode($atts, $content = null) {
        ...
        $wp_rem_var_counter_seperator_style = isset($wp_rem_var_counter_seperator_style) ? $wp_rem_var_counter_seperator_style : '';
        ...
        if ( function_exists('wp_rem_cs_var_page_builder_element_sizes') ) {
            $wp_rem_cs_var_counter .= '<div class="' . wp_rem_cs_var_page_builder_element_sizes($page_element_size,$atts) . ' ">';
        }
        if ( isset($column_class) && $column_class <> '' ) {
            $wp_rem_cs_var_counter .= '<div class="' . esc_html($column_class) . '">';
        }
        $wp_rem_cs_section_title .= wp_rem_title_sub_align($wp_rem_cs_counter_title, $wp_rem_cs_counter_subtitle, $wp_rem_var_counter_align,$wp_rem_cs_var_counter_title_color,$wp_rem_var_counter_seperator_style,$wp_rem_cs_var_counter_subtitle_color);
...
if ( ! function_exists('wp_rem_cs_counter_item') ) {
    ...
    function wp_rem_cs_counter_item($atts, $content = null) {
        ...
        if ( isset($wp_rem_cs_var_counters_view) && $wp_rem_cs_var_counters_view == 'default' ) {
            ...
            if ( $content <> '' ) {
                $wp_rem_cs_var_counter_item .= '<p>' . ($content) . '</p>';
            }
            $wp_rem_cs_var_counter_item .= ' </div>
                                </div>';
        } else {
