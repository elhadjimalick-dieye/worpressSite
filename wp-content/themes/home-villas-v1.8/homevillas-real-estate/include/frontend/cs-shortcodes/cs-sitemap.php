    ...
    'wp_rem_cs_var_site_map_subtitle_color'=>'',
        ...
        <div class="row">
            <div class="sitemap-links">	
                <?php
                $wp_rem_cs_elemement = '';
                $wp_rem_cs_elemement = wp_rem_title_sub_align($wp_rem_cs_sitemap_section_title, $wp_rem_cs_sitemap_section_subtitle, $wp_rem_var_sitemap_align,$wp_rem_cs_var_site_map_title_color,$wp_rem_var_sitemap_seperator_style,$wp_rem_cs_var_site_map_subtitle_color);
