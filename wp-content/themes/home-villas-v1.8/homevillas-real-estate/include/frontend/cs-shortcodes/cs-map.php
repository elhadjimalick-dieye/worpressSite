...
if ( ! function_exists('wp_rem_cs_var_map_shortcode') ) {
    ...
    'wp_rem_cs_var_map_subtitle_color'=>'',
        ...
        $section_title = '';
        $section_title .= wp_rem_title_sub_align($wp_rem_cs_var_map_title, $wp_rem_cs_var_map_subtitle, $wp_rem_var_map_align,$wp_rem_cs_var_map_title_color,$wp_rem_var_map_seperator_style,$wp_rem_cs_var_map_subtitle_color);
