...
if ( ! function_exists( 'wp_rem_cs_var_column' ) ) {
    ...
    function wp_rem_cs_var_column( $atts, $content = "" ) {
       ...
       $wp_rem_var_column_seperator_style = isset( $wp_rem_var_column_seperator_style ) ? $wp_rem_var_column_seperator_style : '';
        ...
        if ( function_exists( 'wp_rem_cs_var_page_builder_element_sizes' ) ) {
            $html_column .= '<div class="' . wp_rem_cs_var_page_builder_element_sizes( $page_element_size,$atts) . ' ">';
        }
        ...
        if ( isset( $wp_rem_cs_var_column_section_title ) && $wp_rem_cs_var_column_section_title != '' ) {
            ...
            $html_column .= wp_rem_title_sub_align($wp_rem_cs_var_column_section_title, $wp_rem_cs_var_column_section_subtitle, $wp_rem_var_column_align,$wp_rem_cs_var_column_title_color,$wp_rem_var_column_seperator_style,$wp_rem_cs_var_column_subtitle_color);
        }
