...
if ( ! function_exists('wp_rem_cs_var_team_shortcode') ) {
    ...
    function wp_rem_cs_var_team_shortcode($atts, $content = "") {
        ...
        $wp_rem_cs_section_title = wp_rem_title_sub_align($wp_rem_cs_var_team_title, $wp_rem_cs_var_team_subtitle, $wp_rem_var_team_align,$wp_rem_cs_var_team_title_color,$wp_rem_var_team_seperator_style,$wp_rem_cs_var_team_subtitle_color);
