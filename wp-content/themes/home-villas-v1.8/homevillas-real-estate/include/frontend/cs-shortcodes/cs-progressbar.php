...
if ( ! function_exists( 'wp_rem_cs_var_progressbars_shortcode' ) ) {
	...
	function wp_rem_cs_var_progressbars_shortcode( $atts, $content = "" ) {
		...
		wp_enqueue_script('skills-progress');
		...
		if ( function_exists( 'wp_rem_cs_var_page_builder_element_sizes' ) ) {
			$output .= '<div class="' . wp_rem_cs_var_page_builder_element_sizes( $page_element_size, $atts ) . ' ">';
		}

		$output .= wp_rem_title_sub_align( $progressbars_element_title, $progressbars_element_subtitle, $wp_rem_var_progressbars_align, $wp_rem_cs_var_progressbar_title_color, $wp_rem_var_progressbar_seperator_style, $wp_rem_cs_var_progressbar_subtitle_color );
