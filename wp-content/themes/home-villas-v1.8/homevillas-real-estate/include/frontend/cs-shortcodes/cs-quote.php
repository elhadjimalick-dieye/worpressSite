...
if ( ! function_exists('wp_rem_cs_var_quote_shortcode') ) {
    ...
    function wp_rem_cs_var_quote_shortcode($atts, $content = "") {
        ...
        $html .= wp_rem_title_sub_align($wp_rem_cs_quote_section_title, $wp_rem_cs_quote_section_subtitle, $wp_rem_var_quote_align,$wp_rem_cs_var_quote_title_color,$wp_rem_var_quote_seperator_style,$wp_rem_cs_var_quote_subtitle_color);
