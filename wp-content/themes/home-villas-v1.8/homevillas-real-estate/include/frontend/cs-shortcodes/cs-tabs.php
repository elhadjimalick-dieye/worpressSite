...
if ( ! function_exists('wp_rem_cs_var_tabs_shortcode') ) {
    ...
    function wp_rem_cs_var_tabs_shortcode($atts, $content = "") {
        ...
        $wp_rem_cs_section_title = wp_rem_title_sub_align($wp_rem_cs_var_element_title, $wp_rem_cs_var_element_subtitle, $wp_rem_var_tabs_align, $wp_rem_cs_var_tabs_title_color, $wp_rem_var_tabs_seperator_style, $wp_rem_cs_var_tabs_subtitle_color);
