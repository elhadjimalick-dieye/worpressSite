...
if ( ! function_exists('wp_rem_cs_faq_shortcode') ) {
    ...
    function wp_rem_cs_faq_shortcode($atts, $content = "") {
        ...
        $html .= wp_rem_title_sub_align($wp_rem_cs_var_faq_main_title, $wp_rem_cs_var_faq_main_subtitle, $wp_rem_var_faq_align,$wp_rem_cs_var_faq_title_color,$wp_rem_var_faq_seperator_style,$wp_rem_cs_var_faq_subtitle_color);
        ...
        return '<div class="' . wp_rem_cs_var_page_builder_element_sizes($page_element_size,$atts) . ' "><div class="faqs' . $faq_classs . '">' . wp_rem_cs_allow_special_char($html) . '</div></div>';
    }
