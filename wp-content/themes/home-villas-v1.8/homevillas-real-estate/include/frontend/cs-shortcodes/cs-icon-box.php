...
$icon_box_list_class = 'cs-icon-boxes-list';
        ...
        $wp_rem_cs_section_title .= wp_rem_title_sub_align($wp_rem_cs_var_icon_boxes_title, $wp_rem_cs_var_icon_boxes_element_sub_title, $wp_rem_cs_var_icon_boxes_element_alignment, $wp_rem_cs_icon_box_content_color,$wp_rem_var_icon_box_seperator_style,$wp_rem_cs_var_icon_box_subtitle_color);
