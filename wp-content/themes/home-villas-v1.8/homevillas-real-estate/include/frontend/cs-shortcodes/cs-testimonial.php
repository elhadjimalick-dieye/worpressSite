...
if ( ! function_exists('wp_rem_cs_testimonials_shortcode') ) {
    ...
    function wp_rem_cs_testimonials_shortcode($atts, $content = null) {
        ...
        if ( $wp_rem_cs_var_testimonial_view == 'modern' ) {
            ...
            $html .= wp_rem_title_sub_align($wp_rem_cs_var_testimonial_title, $wp_rem_cs_var_testimonial_subtitle, $wp_rem_var_testimonial_align, $wp_rem_cs_var_heading_color,$wp_rem_var_testimonial_seperator_style,$wp_rem_cs_var_testimonial_subtitle_color);
...
if ( ! function_exists('wp_rem_cs_testimonial_item') ) {
    ...
    function wp_rem_cs_testimonial_item($atts, $content = null) {
        ...
        $image_bg_url = wp_rem_cs_attachment_image_src($image_bg_id, '2000', '2000');
        $wp_rem_cs_var_testimonial_view = isset($wp_rem_cs_var_testimonial_view) ? $wp_rem_cs_var_testimonial_view : '';
        ...
        if ( $wp_rem_cs_var_testimonial_view == 'modern' ) {
            ...
            if ( isset($content) && $content != '' ) {
                $html .='<p style=""><i class="icon-quotes-left"></i>' . do_shortcode($content) . '</p>';
            }
