...
if ( ! function_exists('wp_rem_cs_var_newsletter') ) {
    ...
    function wp_rem_cs_var_newsletter($atts, $content = "") {
        ...
        if ( function_exists('wp_rem_cs_var_page_builder_element_sizes') ) {
            $newsletter .= '<div class="' . wp_rem_cs_var_page_builder_element_sizes($page_element_size,$atts) . ' ">';
        }
        $defaults = array(
        ...
        $wp_rem_var_newsletter_seperator_style = isset($wp_rem_var_newsletter_seperator_style) ? $wp_rem_var_newsletter_seperator_style : '';
        ...
        if ( $wp_rem_var_newsletter_styles == 'fancy' ) {
            $news_letter_class = 'fancy';
        }
        // Column Class
        $column_class = '';
        ...
        $newsletter .= wp_rem_title_sub_align($wp_rem_cs_var_newsletter_title, $wp_rem_cs_var_newsletter_subtitle, $wp_rem_var_newsletter_align, $wp_rem_cs_var_newsletter_title_color, $wp_rem_var_newsletter_seperator_style, $wp_rem_cs_var_newsletter_subtitle_color);
