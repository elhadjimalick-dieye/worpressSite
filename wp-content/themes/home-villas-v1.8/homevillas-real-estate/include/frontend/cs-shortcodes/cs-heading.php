...
if ( ! function_exists('wp_rem_cs_var_heading') ) {
    ...
    function wp_rem_cs_var_heading($atts, $content = "") {
        ...
        $wp_rem_var_heading_seperator_style = isset($wp_rem_var_heading_seperator_style) ? $wp_rem_var_heading_seperator_style : '';
        ...
        if ( isset($wp_rem_var_heading_seperator_style) && ! empty($wp_rem_var_heading_seperator_style) ) {

            if ( $wp_rem_var_heading_seperator_style == 'classic' ) {
                $html .='<div class="classic-separator ' . $wp_rem_cs_heading_align . '"><span></span></div>';
            }
            if ( $wp_rem_var_heading_seperator_style == 'zigzag' ) {
                $html .='<div class="separator-zigzag ' . $wp_rem_cs_heading_align . '">
