...
if ( ! function_exists( 'wp_rem_cs_accordion_shortcode' ) ) {
    ...
    function wp_rem_cs_accordion_shortcode( $atts, $content = "" ) {
        ...
        $wp_rem_cs_var_accordion_title_color = isset( $wp_rem_cs_var_accordion_title_color ) ? $wp_rem_cs_var_accordion_title_color : '';
        $wp_rem_cs_var_accordion_subtitle_color = isset( $wp_rem_cs_var_accordion_subtitle_color ) ? $wp_rem_cs_var_accordion_subtitle_color : '';
        $wp_rem_var_accordion_seperator_style = isset( $wp_rem_var_accordion_seperator_style ) ? $wp_rem_var_accordion_seperator_style : '';
        ...
        $html .= wp_rem_title_sub_align($wp_rem_cs_var_accordian_main_title, $wp_rem_cs_var_accordian_main_subtitle, $wp_rem_var_accordion_align,$wp_rem_cs_var_accordion_title_color,$wp_rem_var_accordion_seperator_style,$wp_rem_cs_var_accordion_subtitle_color);
