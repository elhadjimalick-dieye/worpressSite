...
if ( ! function_exists('wp_rem_cs_header_main_menu') ) {
    ...
    function wp_rem_cs_header_main_menu() {
        ...
        if ( has_nav_menu('primary') ) {
            ...
            ?>
            <nav id="<?php echo esc_html($custom_id); ?>" class="main-navigation" aria-label="<?php echo wp_rem_cs_var_theme_text_srt('wp_rem_cs_header_primary'); ?>">
                <?php
                wp_nav_menu(array(
                    'container' => ' ',
...
if ( ! function_exists('wp_rem_cs_header_view_1') ) {
    ...
    function wp_rem_cs_header_view_1() {
        global $wp_rem_cs_var_options, $wp_rem_cs_var_form_fields, $wp_rem_plugin_options,$post;
         ...
         */
         ...
         $page_idd = get_the_ID();
         $theme_option_header_full_width = isset($wp_rem_cs_var_options['wp_rem_cs_var_header_full_width']) ? $wp_rem_cs_var_options['wp_rem_cs_var_header_full_width'] : '';
         $page_header_full_width = get_post_meta($page_idd,'wp_rem_cs_var_header_wide_box',true);
         $header_full_width_style = 'container';
         if ( isset($page_header_full_width) && $page_header_full_width == 'on' ) {
            $header_full_width_style = 'container-fluid';
        } elseif ( isset($theme_option_header_full_width) && $theme_option_header_full_width == 'on' ) {
            $header_full_width_style = 'container-fluid';
        }
        ...
        <header id="header" class="header1">
            <div class="main-header">
                <div class="top-header">
                    <div class="<?php echo wp_rem_cs_allow_special_char($header_full_width_style);?>">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="login-area">
                                    ...
                                    if ( isset($wp_rem_plugin_options['wp_rem_user_dashboard_switchs']) &&  $wp_rem_plugin_options['wp_rem_user_dashboard_switchs'] != 'off' && $wp_rem_plugin_options['wp_rem_user_dashboard_switchs'] != '' ) {
                                        ?>
...
if ( ! function_exists('wp_rem_cs_header_view_classic') ) {
    ...
    function wp_rem_cs_header_view_classic() {
        global $post,$wp_rem_cs_var_options, $wp_rem_cs_var_form_fields, $wp_rem_plugin_options;
        $wp_rem_cs_custom_logo = isset($wp_rem_cs_var_options['wp_rem_cs_var_custom_logo']) ? $wp_rem_cs_var_options['wp_rem_cs_var_custom_logo'] : '';
        $wp_rem_cs_logo_height = isset($wp_rem_cs_var_options['wp_rem_cs_var_logo_height']) ? $wp_rem_cs_var_options['wp_rem_cs_var_logo_height'] : '';
        $wp_rem_cs_logo_width = isset($wp_rem_cs_var_options['wp_rem_cs_var_logo_width']) ? $wp_rem_cs_var_options['wp_rem_cs_var_logo_width'] : '';
        $wp_rem_cs_autosidebar = isset($wp_rem_cs_var_options['wp_rem_cs_var_autosidebar']) ? $wp_rem_cs_var_options['wp_rem_cs_var_autosidebar'] : '';
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-6 col-xs-12">
                            ...
                            <?php if ( (isset($wp_rem_plugin_options['wp_rem_create_listing_button']) && $wp_rem_plugin_options['wp_rem_create_listing_button'] != 'off' ) || (isset($wp_rem_plugin_options['wp_rem_user_dashboard_switchs']) && $wp_rem_plugin_options['wp_rem_user_dashboard_switchs'] != 'off') ) { ?>
                                <div class="contact-holder">
                                    <?php if ( isset($wp_rem_plugin_options['wp_rem_user_dashboard_switchs']) &&  $wp_rem_plugin_options['wp_rem_user_dashboard_switchs'] != 'off' && $wp_rem_plugin_options['wp_rem_user_dashboard_switchs'] != '' ) { ?>
