...
if ( ! function_exists('wp_rem_cs_var_page_builder_clients') ) {
    ...
    function wp_rem_cs_var_page_builder_clients($die = 0) {
        ...
        $defaults = array(
            ...
            'clients_text_color' => '',
            'wp_rem_cs_var_clients_title_color' => '',
            'wp_rem_cs_var_clients_subtitle_color' => '',
            'wp_rem_var_clients_seperator_style'=> '',
        );
        ...
        <div id="<?php echo wp_rem_cs_allow_special_char($name . $wp_rem_cs_counter) ?>_del" class="column  parentdelete <?php echo wp_rem_cs_allow_special_char($coloumn_class); ?> <?php echo wp_rem_cs_allow_special_char($shortcode_view); ?>" item="clients" data="<?php echo wp_rem_cs_element_size_data_array_index($clients_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo wp_rem_cs_allow_special_char($wp_rem_cs_counter) ?> <?php echo wp_rem_cs_allow_special_char($shortcode_element); ?>" id="<?php echo wp_rem_cs_allow_special_char($name . $wp_rem_cs_counter) ?>" style="display: none;">
                ...
                <div class="cs-clone-append cs-pbwp-content">
                        ...
                        <div id="shortcode-item-<?php echo wp_rem_cs_allow_special_char($wp_rem_cs_counter); ?>" data-shortcode-template="{{child_shortcode}} [/wp_rem_cs_clients]" data-shortcode-child-template="[clients_item {{attributes}}] {{content}} [/clients_item]">
                            <div class="cs-wrapp-clone cs-shortcode-wrapp cs-disable-true cs-pbwp-content" data-template="[wp_rem_cs_clients {{attributes}}]">
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_clients_title_color),
                                        'cust_name' => 'wp_rem_cs_var_clients_title_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_clients_subtitle_color),
                                        'cust_name' => 'wp_rem_cs_var_clients_subtitle_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                    ...
                    'echo' => true,
                    'field_params' => array(
                        'std' => $wp_rem_var_clients_seperator_style,
                        'id' => '',
                        'cust_name' => 'wp_rem_var_clients_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_clients_callback($args) {
        ...
        if ( $widget_type == "clients" || $widget_type == "cs_clients" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_var_clients_seperator_style'][$counters['wp_rem_cs_counter_clients']]) && $data['wp_rem_var_clients_seperator_style'][$counters['wp_rem_cs_counter_clients']] != '' ) {
                    $section_title .= 'wp_rem_var_clients_seperator_style="' . htmlspecialchars($data['wp_rem_var_clients_seperator_style'][$counters['wp_rem_cs_counter_clients']], ENT_QUOTES) . '" ';
                }
                ...
                if ( isset($data['wp_rem_cs_var_clients_subtitle_color'][$counters['wp_rem_cs_counter_clients']]) && $data['wp_rem_cs_var_clients_subtitle_color'][$counters['wp_rem_cs_counter_clients']] != '' ) {
                    $section_title .= 'wp_rem_cs_var_clients_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_clients_subtitle_color'][$counters['wp_rem_cs_counter_clients']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_cs_var_clients_title_color'][$counters['wp_rem_cs_counter_clients']]) && $data['wp_rem_cs_var_clients_title_color'][$counters['wp_rem_cs_counter_clients']] != '' ) {
                    $section_title .= 'wp_rem_cs_var_clients_title_color="' . htmlspecialchars($data['wp_rem_cs_var_clients_title_color'][$counters['wp_rem_cs_counter_clients']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_var_clients_view'][$counters['wp_rem_cs_counter_clients']]) && $data['wp_rem_var_clients_view'][$counters['wp_rem_cs_counter_clients']] != '' ) {
                 ...
                 // Apply filter on default attributes Saving
                   $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $section_title, $data, $counters['wp_rem_cs_counter_clients'], array( 'responsive_atts' => true ));
