...
if ( ! function_exists('wp_rem_cs_var_page_builder_sitemap') ) {
    ...
    function wp_rem_cs_var_page_builder_sitemap($die = 0) {
        ...
        $defaults = array(
            ...
            'wp_rem_cs_var_site_map_title_color' => '',
            'wp_rem_cs_var_site_map_subtitle_color' => '',
            'wp_rem_var_sitemap_seperator_style' => '',
        );
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        ...
                        $wp_rem_cs_opt_array = array(
                            ...
                            'echo' => true,
                            'field_params' => array(
                                'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_site_map_title_color),
                                'cust_name' => 'wp_rem_cs_var_site_map_title_color[]',
                                'classes' => 'bg_color',
                                'return' => true,
                            ),
                        );
                        ...
                        $wp_rem_cs_opt_array = array(
                            ...
                            'echo' => true,
                            'field_params' => array(
                                'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_site_map_subtitle_color),
                                'cust_name' => 'wp_rem_cs_var_site_map_subtitle_color[]',
                                'classes' => 'bg_color',
                                'return' => true,
                            ),
                        );
                        ...
                        $wp_rem_opt_array = array(
                            ...
                            'echo' => true,
                            'field_params' => array(
                                'std' => $wp_rem_var_sitemap_seperator_style,
                                'id' => '',
                                'cust_name' => 'wp_rem_var_sitemap_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_sitemap_callback($args) {
        ...
        if ( $widget_type == "sitemap" || $widget_type == "cs_sitemap" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_cs_var_site_map_title_color'][$counters['wp_rem_cs_counter_sitemap']]) && $data['wp_rem_cs_var_site_map_title_color'][$counters['wp_rem_cs_counter_sitemap']] != '' ) {
                    $shortcode .= 'wp_rem_cs_var_site_map_title_color="' . htmlspecialchars($data['wp_rem_cs_var_site_map_title_color'][$counters['wp_rem_cs_counter_sitemap']]) . '" ';
                }
                if ( isset($data['wp_rem_cs_var_site_map_subtitle_color'][$counters['wp_rem_cs_counter_sitemap']]) && $data['wp_rem_cs_var_site_map_subtitle_color'][$counters['wp_rem_cs_counter_sitemap']] != '' ) {
                    $shortcode .= 'wp_rem_cs_var_site_map_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_site_map_subtitle_color'][$counters['wp_rem_cs_counter_sitemap']]) . '" ';
                }
                if ( isset($data['wp_rem_var_sitemap_seperator_style'][$counters['wp_rem_cs_counter_sitemap']]) && $data['wp_rem_var_sitemap_seperator_style'][$counters['wp_rem_cs_counter_sitemap']] != '' ) {
                    $shortcode .= 'wp_rem_var_sitemap_seperator_style="' . htmlspecialchars($data['wp_rem_var_sitemap_seperator_style'][$counters['wp_rem_cs_counter_sitemap']]) . '" ';
                }
                $shortcode .= ']';
