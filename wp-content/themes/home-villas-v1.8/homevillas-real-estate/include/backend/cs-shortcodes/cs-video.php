    ...
    function wp_rem_cs_var_page_builder_video($die = 0) {
        ...
        if (function_exists('wp_rem_cs_shortcode_names')) {
            ...
            $defaults = array(
                ...
                'wp_rem_cs_var_video_title_color'=>'',
                'wp_rem_cs_var_video_subtitle_color'=>'',
                'wp_rem_var_video_seperator_style'=> '',
            );
            ...
            <div id="<?php echo esc_attr($name . $wp_rem_cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?>
                ...
                <div class="cs-wrapp-class-<?php echo intval($wp_rem_cs_counter) ?>
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_video_title_color),
                                        'cust_name' => 'wp_rem_cs_var_video_title_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_video_subtitle_color),
                                        'cust_name' => 'wp_rem_cs_var_video_subtitle_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                    ...
                    'echo' => true,
                    'field_params' => array(
                        'std' => $wp_rem_var_video_seperator_style,
                        'id' => '',
                        'cust_name' => 'wp_rem_var_video_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_video_callback($args) {
        ...
        if ($widget_type == "video" || $widget_type == "cs_video") {
            ...
            if (isset($_POST['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $_POST['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode') {
                ...
                if (isset($_POST['wp_rem_cs_var_video_title_color'][$counters['wp_rem_cs_counter_video']]) && $_POST['wp_rem_cs_var_video_title_color'][$counters['wp_rem_cs_counter_video']] != '') {
                    $shortcode .='wp_rem_cs_var_video_title_color="' . htmlspecialchars($_POST['wp_rem_cs_var_video_title_color'][$counters['wp_rem_cs_counter_video']], ENT_QUOTES) . '" ';
                }
                if (isset($_POST['wp_rem_cs_var_video_subtitle_color'][$counters['wp_rem_cs_counter_video']]) && $_POST['wp_rem_cs_var_video_subtitle_color'][$counters['wp_rem_cs_counter_video']] != '') {
                    $shortcode .='wp_rem_cs_var_video_subtitle_color="' . htmlspecialchars($_POST['wp_rem_cs_var_video_subtitle_color'][$counters['wp_rem_cs_counter_video']], ENT_QUOTES) . '" ';
                }
                ...
                if (isset($_POST['wp_rem_var_video_seperator_style'][$counters['wp_rem_cs_counter_video']]) && $_POST['wp_rem_var_video_seperator_style'][$counters['wp_rem_cs_counter_video']] != '') {
                    $shortcode .='wp_rem_var_video_seperator_style="' . htmlspecialchars($_POST['wp_rem_var_video_seperator_style'][$counters['wp_rem_cs_counter_video']], ENT_QUOTES) . '" ';
                }
                ...
                $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $shortcode, $data, $counters['wp_rem_cs_counter_video'], array( 'responsive_atts' => true ));
