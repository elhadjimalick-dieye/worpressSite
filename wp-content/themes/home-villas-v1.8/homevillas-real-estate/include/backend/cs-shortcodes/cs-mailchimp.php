    ...
    function wp_rem_cs_var_page_builder_mail_chimp($die = 0) {
        ...
        if ( function_exists('wp_rem_cs_shortcode_names') ) {
            ...
            $defaults = array(
                ...
                'wp_rem_cs_var_mailchimp_title_color' => '',
                'wp_rem_cs_var_mailchimp_subtitle_color' => '',
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_cs_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_mailchimp_title_color),
                                    'cust_name' => 'wp_rem_cs_var_mailchimp_title_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_cs_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_mailchimp_subtitle_color),
                                    'cust_name' => 'wp_rem_cs_var_mailchimp_subtitle_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
    ...
    function wp_rem_cs_save_page_builder_data_mail_chimp_callback($args) {
        ...
        if ( $widget_type == "mail_chimp" || $widget_type == "cs_mail_chimp" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_cs_var_mailchimp_title_color'][$counters['wp_rem_cs_counter_mail_chimp']]) && $data['wp_rem_cs_var_mailchimp_title_color'][$counters['wp_rem_cs_counter_mail_chimp']] != '' ) {
                    $wp_rem_cs_var_mail_chimp .= 'wp_rem_cs_var_mailchimp_title_color="' . htmlspecialchars($data['wp_rem_cs_var_mailchimp_title_color'][$counters['wp_rem_cs_counter_mail_chimp']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_cs_var_mailchimp_subtitle_color'][$counters['wp_rem_cs_counter_mail_chimp']]) && $data['wp_rem_cs_var_mailchimp_subtitle_color'][$counters['wp_rem_cs_counter_mail_chimp']] != '' ) {
                    $wp_rem_cs_var_mail_chimp .= 'wp_rem_cs_var_mailchimp_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_mailchimp_subtitle_color'][$counters['wp_rem_cs_counter_mail_chimp']], ENT_QUOTES) . '" ';
                }
