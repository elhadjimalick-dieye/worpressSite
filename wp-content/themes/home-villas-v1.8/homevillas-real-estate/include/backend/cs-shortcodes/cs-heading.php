...
if ( ! function_exists('wp_rem_cs_var_page_builder_heading') ) {
    ...
    function wp_rem_cs_var_page_builder_heading($die = 0) {
        ...
        $defaults = array(
            ...
            'wp_rem_var_heading_seperator_style' => '',
        );
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        ...
                        $wp_rem_opt_array = array(
                            ...
                            'echo' => true,
                            'field_params' => array(
                                'std' => $wp_rem_var_heading_seperator_style,
                                'id' => '',
                                'cust_name' => 'wp_rem_var_heading_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_heading_callback($args) {
        ...
        if ( $widget_type == "heading" || $widget_type == "cs_heading" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_var_heading_seperator_style'][$counters['wp_rem_cs_counter_heading']]) && $data['wp_rem_var_heading_seperator_style'][$counters['wp_rem_cs_counter_heading']] != '' ) {
                    $wp_rem_cs_var_heading .= 'wp_rem_var_heading_seperator_style="' . htmlspecialchars($data['wp_rem_var_heading_seperator_style'][$counters['wp_rem_cs_counter_heading']]) . '" ';
                }
                ...
                $wp_rem_cs_var_headingg = apply_filters('wp_rem_shortcode_default_atts_save', $wp_rem_cs_var_heading, $data, $counters['wp_rem_cs_counter_heading'], array( 'responsive_atts' => true ));
                $wp_rem_cs_var_heading = $wp_rem_cs_var_headingg;
                $wp_rem_cs_var_heading .= ']';
