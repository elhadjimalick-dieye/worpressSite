...
if (!function_exists('wp_rem_cs_var_page_builder_call_to_action')) {
    ...
    function wp_rem_cs_var_page_builder_call_to_action($die = 0) {
        ...
        $defaults = array(
            ...
            'wp_rem_cs_var_call_to_action_title_color'=>'',
            'wp_rem_cs_var_call_to_action_subtitle_color'=>'',
             'wp_rem_var_call_to_action_seperator_style'=> '',
        );
...
$defaults = apply_filters('wp_rem_shortcode_default_atts', $defaults, array('responsive_atts' => true));
        ...
        $wp_rem_cs_var_call_to_action_title_color = isset( $wp_rem_cs_var_call_to_action_title_color ) ? $wp_rem_cs_var_call_to_action_title_color : '';
    $wp_rem_cs_var_call_to_action_subtitle_color = isset( $wp_rem_cs_var_call_to_action_subtitle_color ) ? $wp_rem_cs_var_call_to_action_subtitle_color : '';
        ...
        <div id="<?php echo esc_attr($name . $wp_rem_cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?>
            ...
            <div class="cs-wrapp-class-<?php echo intval($wp_rem_cs_counter) ?>
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content">
                        ...
                        $wp_rem_cs_var_html_fields->wp_rem_cs_var_select_field($wp_rem_opt_array);
                         ...
                         $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_call_to_action_title_color),
                                        'cust_name' => 'wp_rem_cs_var_call_to_action_title_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_call_to_action_subtitle_color),
                                        'cust_name' => 'wp_rem_cs_var_call_to_action_subtitle_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                    ...
                    'echo' => true,
                    'field_params' => array(
                        'std' => $wp_rem_var_call_to_action_seperator_style,
                        'id' => '',
                        'cust_name' => 'wp_rem_var_call_to_action_seperator_style[]',
...
if (!function_exists('wp_rem_cs_save_page_builder_data_call_to_action_callback')) {
    ...
    function wp_rem_cs_save_page_builder_data_call_to_action_callback($args) {
        ...
        if ($widget_type == "call_to_action" || $widget_type == "cs_call_to_action") {
            ...
            if (isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode') {
                ...
                if (isset($data['wp_rem_cs_var_call_to_action_title_color'][$counters['wp_rem_cs_counter_call_to_action']]) && $data['wp_rem_cs_var_call_to_action_title_color'][$counters['wp_rem_cs_counter_call_to_action']] != '') {
                    $shortcode .= 'wp_rem_cs_var_call_to_action_title_color="' . stripslashes(htmlspecialchars(($data['wp_rem_cs_var_call_to_action_title_color'][$counters['wp_rem_cs_counter_call_to_action']]), ENT_QUOTES)) . '" ';
                }
                if (isset($data['wp_rem_cs_var_call_to_action_subtitle_color'][$counters['wp_rem_cs_counter_call_to_action']]) && $data['wp_rem_cs_var_call_to_action_subtitle_color'][$counters['wp_rem_cs_counter_call_to_action']] != '') {
                    $shortcode .= 'wp_rem_cs_var_call_to_action_subtitle_color="' . stripslashes(htmlspecialchars(($data['wp_rem_cs_var_call_to_action_subtitle_color'][$counters['wp_rem_cs_counter_call_to_action']]), ENT_QUOTES)) . '" ';
                }
                if (isset($data['wp_rem_var_call_to_action_seperator_style'][$counters['wp_rem_cs_counter_call_to_action']]) && $data['wp_rem_var_call_to_action_seperator_style'][$counters['wp_rem_cs_counter_call_to_action']] != '') {
                    $shortcode .= 'wp_rem_var_call_to_action_seperator_style="' . stripslashes(htmlspecialchars(($data['wp_rem_var_call_to_action_seperator_style'][$counters['wp_rem_cs_counter_call_to_action']]), ENT_QUOTES)) . '" ';
                }
  ...
  $shortcodee = apply_filters('wp_rem_shortcode_default_atts_save', $shortcode, $data, $counters['wp_rem_cs_counter_call_to_action'], array( 'responsive_atts' => true ));
