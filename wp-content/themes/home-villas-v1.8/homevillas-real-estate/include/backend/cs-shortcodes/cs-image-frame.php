    ...
    function wp_rem_cs_var_page_builder_image_frame($die = 0) {
        ...
        if ( function_exists('wp_rem_cs_shortcode_names') ) {
            ...
            $defaults = array(
                ...
                'wp_rem_cs_var_image_frame_title_color' => '',
                'wp_rem_cs_var_image_frame_subtitle_color' => '',
                'wp_rem_var_image_frame_seperator_style'=> '',
            );
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_cs_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_image_frame_title_color),
                                    'cust_name' => 'wp_rem_cs_var_image_frame_title_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_cs_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_image_frame_subtitle_color),
                                    'cust_name' => 'wp_rem_cs_var_image_frame_subtitle_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => $wp_rem_var_image_frame_seperator_style,
                                        'id' => '',
                                        'cust_name' => 'wp_rem_var_image_frame_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_image_frame_callback($args) {
        ...
        if ( $widget_type == "image_frame" || $widget_type == "cs_image_frame" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_var_image_frame_seperator_style'][$counters['wp_rem_cs_counter_image_frame']]) && $data['wp_rem_var_image_frame_seperator_style'][$counters['wp_rem_cs_counter_image_frame']] != '' ) {
                    $wp_rem_cs_var_image_frame .= 'wp_rem_var_image_frame_seperator_style="' . htmlspecialchars($data['wp_rem_var_image_frame_seperator_style'][$counters['wp_rem_cs_counter_image_frame']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_cs_var_image_frame_title_color'][$counters['wp_rem_cs_counter_image_frame']]) && $data['wp_rem_cs_var_image_frame_title_color'][$counters['wp_rem_cs_counter_image_frame']] != '' ) {
                    $wp_rem_cs_var_image_frame .= 'wp_rem_cs_var_image_frame_title_color="' . htmlspecialchars($data['wp_rem_cs_var_image_frame_title_color'][$counters['wp_rem_cs_counter_image_frame']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_cs_var_image_frame_subtitle_color'][$counters['wp_rem_cs_counter_image_frame']]) && $data['wp_rem_cs_var_image_frame_subtitle_color'][$counters['wp_rem_cs_counter_image_frame']] != '' ) {
                    $wp_rem_cs_var_image_frame .= 'wp_rem_cs_var_image_frame_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_image_frame_subtitle_color'][$counters['wp_rem_cs_counter_image_frame']], ENT_QUOTES) . '" ';
                }
                ...
                $wp_rem_cs_var_image_framee = apply_filters('wp_rem_shortcode_default_atts_save', $wp_rem_cs_var_image_frame, $data, $counters['wp_rem_cs_counter_image_frame'], array( 'responsive_atts' => true ));
                
                    $wp_rem_cs_var_image_frame = $wp_rem_cs_var_image_framee;
