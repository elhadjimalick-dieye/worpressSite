...
if ( ! function_exists('wp_rem_cs_var_page_builder_tweets') ) {
    ...
    function wp_rem_cs_var_page_builder_tweets($die = 0) {
        ...
        $defaults = array(
            ...
            'wp_rem_cs_var_tweet_title' => '',
            'wp_rem_cs_var_tweet_subtitle' => '',
            'wp_rem_var_tweet_align' => '',
            'wp_rem_api_consumer_secret_key' => '',
            'wp_rem_api_access_token_key' => '',
            'wp_rem_api_access_token_secret_key' => '',
            'wp_rem_cs_var_tweets_title_color'=>'',
            'wp_rem_cs_var_tweets_subtitle_color'=>'',
            'wp_rem_var_tweets_seperator_style'=> '',
        );
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content">
                        ...
                        $wp_rem_cs_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($wp_rem_cs_var_tweet_title),
                                    'classes' => '',
                                    'cust_name' => 'wp_rem_cs_var_tweet_title[]',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_cs_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($wp_rem_cs_var_tweet_subtitle),
                                    'classes' => '',
                                    'cust_name' => 'wp_rem_cs_var_tweet_subtitle[]',
                                    'return' => true,
                                ),
                            );
                            $wp_rem_cs_var_html_fields->wp_rem_cs_var_text_field($wp_rem_cs_opt_array);
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_var_tweet_align,
                                    'id' => '',
                                    'cust_name' => 'wp_rem_var_tweet_align[]',
                            ...
                            $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_tweets_title_color),
                                        'cust_name' => 'wp_rem_cs_var_tweets_title_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_tweets_subtitle_color),
                                        'cust_name' => 'wp_rem_cs_var_tweets_subtitle_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                    ...
                    'echo' => true,
                    'field_params' => array(
                        'std' => $wp_rem_var_tweets_seperator_style,
                        'id' => '',
                        'cust_name' => 'wp_rem_var_tweets_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_tweets_callback($args) {
        ...
        if ( $widget_type == "tweets" || $widget_type == "cs_tweets" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_cs_var_tweet_title'][$counters['wp_rem_cs_counter_tweets']]) && $data['wp_rem_cs_var_tweet_title'][$counters['wp_rem_cs_counter_tweets']] != '' ) {
                    $shortcode .='wp_rem_cs_var_tweet_title="' . htmlspecialchars($data['wp_rem_cs_var_tweet_title'][$counters['wp_rem_cs_counter_tweets']]) . '" ';
                }
                if ( isset($data['wp_rem_cs_var_tweet_subtitle'][$counters['wp_rem_cs_counter_tweets']]) && $data['wp_rem_cs_var_tweet_subtitle'][$counters['wp_rem_cs_counter_tweets']] != '' ) {
                    $shortcode .='wp_rem_cs_var_tweet_subtitle="' . htmlspecialchars($data['wp_rem_cs_var_tweet_subtitle'][$counters['wp_rem_cs_counter_tweets']]) . '" ';
                }
                if ( isset($data['wp_rem_var_tweet_align'][$counters['wp_rem_cs_counter_tweets']]) && $data['wp_rem_var_tweet_align'][$counters['wp_rem_cs_counter_tweets']] != '' ) {
                    $shortcode .='wp_rem_var_tweet_align="' . htmlspecialchars($data['wp_rem_var_tweet_align'][$counters['wp_rem_cs_counter_tweets']]) . '" ';
                }
                if ( isset($data['wp_rem_cs_var_tweets_title_color'][$counters['wp_rem_cs_counter_tweets']]) && $data['wp_rem_cs_var_tweets_title_color'][$counters['wp_rem_cs_counter_tweets']] != '' ) {
                    $shortcode .='wp_rem_cs_var_tweets_title_color="' . htmlspecialchars($data['wp_rem_cs_var_tweets_title_color'][$counters['wp_rem_cs_counter_tweets']]) . '" ';
                }
                if ( isset($data['wp_rem_cs_var_tweets_subtitle_color'][$counters['wp_rem_cs_counter_tweets']]) && $data['wp_rem_cs_var_tweets_subtitle_color'][$counters['wp_rem_cs_counter_tweets']] != '' ) {
                    $shortcode .='wp_rem_cs_var_tweets_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_tweets_subtitle_color'][$counters['wp_rem_cs_counter_tweets']]) . '" ';
                }
                ...
                if ( isset($data['wp_rem_var_tweets_seperator_style'][$counters['wp_rem_cs_counter_tweets']]) && $data['wp_rem_var_tweets_seperator_style'][$counters['wp_rem_cs_counter_tweets']] != '' ) {
                    $shortcode .='wp_rem_var_tweets_seperator_style="' . htmlspecialchars($data['wp_rem_var_tweets_seperator_style'][$counters['wp_rem_cs_counter_tweets']]) . '" ';
                }
                ...
                $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $shortcode, $data, $counters['wp_rem_cs_counter_accordion'], array( 'responsive_atts' => true ));
