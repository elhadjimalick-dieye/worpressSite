...
if ( ! function_exists('wp_rem_cs_var_page_builder_tabs') ) {
    ...
    function wp_rem_cs_var_page_builder_tabs($die = 0) {
        ...
        $defaults = array(
            ...
            'wp_rem_cs_var_tabs_title_color' => '',
            'wp_rem_cs_var_tabs_subtitle_color' => '',
            'wp_rem_var_tabs_seperator_style' => '',
        );
                        ...
                        <div id="shortcode-item-<?php echo wp_rem_cs_allow_special_char($wp_rem_cs_counter); ?>" data-shortcode-template="{{child_shortcode}} [/tabs]" data-shortcode-child-template="[tabs_item {{attributes}}] {{content}} [/tabs_item]">
                            <div class="cs-wrapp-clone cs-shortcode-wrapp cs-disable-true cs-pbwp-content" data-template="[tabs {{attributes}}]">
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_tabs_title_color),
                                        'cust_name' => 'wp_rem_cs_var_tabs_title_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_tabs_subtitle_color),
                                        'cust_name' => 'wp_rem_cs_var_tabs_subtitle_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => $wp_rem_var_tabs_seperator_style,
                                        'id' => '',
                                        'cust_name' => 'wp_rem_var_tabs_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_tabs_callback($args) {
        ...
        if ( $widget_type == "tabs" || $widget_type == "cs_tabs" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_var_tabs_seperator_style'][$counters['wp_rem_cs_counter_tabs']]) && $data['wp_rem_var_tabs_seperator_style'][$counters['wp_rem_cs_counter_tabs']] != '' ) {
                    $section_title .= 'wp_rem_var_tabs_seperator_style="' . htmlspecialchars($data['wp_rem_var_tabs_seperator_style'][$counters['wp_rem_cs_counter_tabs']], ENT_QUOTES) . '" ';
                }
                ...
                if ( isset($data['wp_rem_cs_var_tabs_title_color'][$counters['wp_rem_cs_counter_tabs']]) && $data['wp_rem_cs_var_tabs_title_color'][$counters['wp_rem_cs_counter_tabs']] != '' ) {
                    $section_title .= 'wp_rem_cs_var_tabs_title_color="' . htmlspecialchars($data['wp_rem_cs_var_tabs_title_color'][$counters['wp_rem_cs_counter_tabs']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_cs_var_tabs_subtitle_color'][$counters['wp_rem_cs_counter_tabs']]) && $data['wp_rem_cs_var_tabs_subtitle_color'][$counters['wp_rem_cs_counter_tabs']] != '' ) {
                    $section_title .= 'wp_rem_cs_var_tabs_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_tabs_subtitle_color'][$counters['wp_rem_cs_counter_tabs']], ENT_QUOTES) . '" ';
                }
                ...
                $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $section_title, $data, $counters['wp_rem_cs_counter_tabs'], array( 'responsive_atts' => true ));
