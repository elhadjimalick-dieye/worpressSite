...
if ( ! function_exists('wp_rem_cs_var_page_builder_team') ) {
    ...
    function wp_rem_cs_var_page_builder_team($die = 0) {
        ...
        $defaults = array(
            ...
            'wp_rem_cs_var_team_title_color' => '',
            'wp_rem_cs_var_team_subtitle_color' => '',
            'wp_rem_cs_var_team_col' => '',
            'wp_rem_cs_var_team_views' => '',
            'wp_rem_var_team_align' => '',
            'team_counter' => '',
             'wp_rem_var_team_seperator_style'=> '',
        );
        ...
        <div id="<?php echo wp_rem_cs_allow_special_char($name . $wp_rem_cs_counter) ?>_del" class="column  parentdelete <?php echo wp_rem_cs_allow_special_char($coloumn_class); ?> <?php echo wp_rem_cs_allow_special_char($shortcode_view); ?>" item="team" data="<?php echo wp_rem_cs_element_size_data_array_index($team_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo wp_rem_cs_allow_special_char($wp_rem_cs_counter) ?> <?php echo wp_rem_cs_allow_special_char($shortcode_element); ?>" id="<?php echo wp_rem_cs_allow_special_char($name . $wp_rem_cs_counter) ?>" style="display: none;">
                ...
                <div class="cs-clone-append cs-pbwp-content">
                        ...
                        <div id="shortcode-item-<?php echo wp_rem_cs_allow_special_char($wp_rem_cs_counter); ?>" data-shortcode-template="{{child_shortcode}} [/wp_rem_cs_team]" data-shortcode-child-template="[wp_rem_cs_team_item {{attributes}}] {{content}} [/wp_rem_cs_team_item]">
                            <div class="cs-wrapp-clone cs-shortcode-wrapp cs-disable-true cs-pbwp-content" data-template="[wp_rem_cs_team {{attributes}}]">
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_team_title_color),
                                        'cust_name' => 'wp_rem_cs_var_team_title_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_team_subtitle_color),
                                        'cust_name' => 'wp_rem_cs_var_team_subtitle_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                    ...
                    'echo' => true,
                    'field_params' => array(
                        'std' => $wp_rem_var_team_seperator_style,
                        'id' => '',
                        'cust_name' => 'wp_rem_var_team_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_team_callback($args) {
        ...
        if ( $widget_type == "team" || $widget_type == "cs_team" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_cs_var_team_title_color'][$counters['wp_rem_cs_counter_team']]) && $data['wp_rem_cs_var_team_title_color'][$counters['wp_rem_cs_counter_team']] != '' ) {
                    $section_title .= 'wp_rem_cs_var_team_title_color="' . htmlspecialchars($data['wp_rem_cs_var_team_title_color'][$counters['wp_rem_cs_counter_team']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_cs_var_team_subtitle_color'][$counters['wp_rem_cs_counter_team']]) && $data['wp_rem_cs_var_team_subtitle_color'][$counters['wp_rem_cs_counter_team']] != '' ) {
                    $section_title .= 'wp_rem_cs_var_team_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_team_subtitle_color'][$counters['wp_rem_cs_counter_team']], ENT_QUOTES) . '" ';
                }
                ...
                if ( isset($data['wp_rem_var_team_seperator_style'][$counters['wp_rem_cs_counter_team']]) && $data['wp_rem_var_team_seperator_style'][$counters['wp_rem_cs_counter_team']] != '' ) {
                    $section_title .= 'wp_rem_var_team_seperator_style="' . htmlspecialchars($data['wp_rem_var_team_seperator_style'][$counters['wp_rem_cs_counter_team']], ENT_QUOTES) . '" ';
                }
                
                 // Apply filter on default attributes Saving
                 $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $section_title, $data, $counters['wp_rem_cs_counter_team'], array( 'responsive_atts' => true ));
