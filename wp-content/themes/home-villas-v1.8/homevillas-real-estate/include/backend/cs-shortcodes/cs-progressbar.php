...
if ( ! function_exists('wp_rem_cs_var_page_builder_progressbars') ) {
    ...
    function wp_rem_cs_var_page_builder_progressbars($die = 0) {
        ...
        $defaults = array(
            ...
            'wp_rem_cs_var_progressbar_title_color' => '',
            'wp_rem_cs_var_progressbar_subtitle_color' => '',
            'wp_rem_var_progressbar_seperator_style'=> '',
        );
        ...
        <div id="<?php echo esc_attr($name . $wp_rem_cs_counter); ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="progressbars" data="<?php echo wp_rem_cs_element_size_data_array_index($progressbars_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo esc_attr($wp_rem_cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $wp_rem_cs_counter); ?>" style="display: none;">
                ...
                <div class="cs-clone-append cs-pbwp-content" >
                        ...
                        <div id="shortcode-item-<?php echo esc_attr($wp_rem_cs_counter); ?>" data-shortcode-template="{{child_shortcode}} [/<?php echo esc_attr('wp_rem_cs_progressbar'); ?>]" data-shortcode-child-template="[<?php echo esc_attr('progressbar_item'); ?> {{attributes}}] {{content}} [/<?php echo esc_attr('progressbar_item'); ?>]">
                            <div class="cs-wrapp-clone cs-shortcode-wrapp cs-disable-true cs-pbwp-content" data-template="[<?php echo esc_attr('wp_rem_cs_progressbar'); ?> {{attributes}}]">
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_progressbar_title_color),
                                        'cust_name' => 'wp_rem_cs_var_progressbar_title_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_progressbar_subtitle_color),
                                        'cust_name' => 'wp_rem_cs_var_progressbar_subtitle_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                    ...
                    'echo' => true,
                    'field_params' => array(
                        'std' => $wp_rem_var_progressbar_seperator_style,
                        'id' => '',
                        'cust_name' => 'wp_rem_var_progressbar_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_progressbar_callback($args) {
        ...
        if ( $widget_type == "progressbars" || $widget_type == "cs_progressbars" ) {
            ...
            if ( isset($_POST['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $_POST['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($_POST['wp_rem_cs_var_progressbar_title_color'][$counters['wp_rem_cs_counter_progressbars']]) && $_POST['wp_rem_cs_var_progressbar_title_color'][$counters['wp_rem_cs_counter_progressbars']] != '' ) {
                    $shortcode .= 'wp_rem_cs_var_progressbar_title_color="' . htmlspecialchars($_POST['wp_rem_cs_var_progressbar_title_color'][$counters['wp_rem_cs_counter_progressbars']], ENT_QUOTES) . '" ';
                }
                if ( isset($_POST['wp_rem_cs_var_progressbar_subtitle_color'][$counters['wp_rem_cs_counter_progressbars']]) && $_POST['wp_rem_cs_var_progressbar_subtitle_color'][$counters['wp_rem_cs_counter_progressbars']] != '' ) {
                    $shortcode .= 'wp_rem_cs_var_progressbar_subtitle_color="' . htmlspecialchars($_POST['wp_rem_cs_var_progressbar_subtitle_color'][$counters['wp_rem_cs_counter_progressbars']], ENT_QUOTES) . '" ';
                }
                if ( isset($_POST['wp_rem_var_progressbar_seperator_style'][$counters['wp_rem_cs_counter_progressbars']]) && $_POST['wp_rem_var_progressbar_seperator_style'][$counters['wp_rem_cs_counter_progressbars']] != '' ) {
                    $shortcode .= 'wp_rem_var_progressbar_seperator_style="' . htmlspecialchars($_POST['wp_rem_var_progressbar_seperator_style'][$counters['wp_rem_cs_counter_progressbars']], ENT_QUOTES) . '" ';
                }
                
                 // Apply filter on default attributes Saving
                $shortcode = apply_filters('wp_rem_shortcode_default_atts_save', $shortcode, $data, $counters['wp_rem_cs_counter_progressbars'], array( 'responsive_atts' => true ));
