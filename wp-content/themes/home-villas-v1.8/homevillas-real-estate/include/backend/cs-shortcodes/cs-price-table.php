...
if (!function_exists('wp_rem_cs_var_page_builder_price_table')) {
	...
	$defaults = array(
	    ...
	    'wp_rem_cs_price_table_element_title_color' => '',
	    'pricing_table_btn_2_lnk' => '',
	    'pricing_table_cmpre_btn_txt' => '',
	    'pricing_table_cmpre_btn_lnk' => '',
	    'wp_rem_cs_multi_price_col' => '',
	    'wp_rem_cs_var_price_table_subtitle_color' => '',
	    'wp_rem_var_price_table_seperator_style' => '',
	);
	...
	<div id="<?php echo wp_rem_cs_allow_special_char($name . $wp_rem_cs_counter) ?>_del" class="column  parentdelete <?php echo wp_rem_cs_allow_special_char($coloumn_class); ?> <?php echo wp_rem_cs_allow_special_char($shortcode_view); ?>" item="price_table" data="<?php echo wp_rem_cs_element_size_data_array_index($price_table_element_size) ?>" >
		...
		<div class="cs-clone-append cs-pbwp-content">
			...
			<div id="shortcode-item-<?php echo wp_rem_cs_allow_special_char($wp_rem_cs_counter); ?>" data-shortcode-template="{{child_shortcode}} [/wp_rem_cs_price_table]" data-shortcode-child-template="[price_table_item {{attributes}}] {{content}} [/price_table_item]">
				...
				$wp_rem_cs_opt_array = array(
				    'name' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_element_price_table_element_title_color'),
				    'desc' => '',
				    'hint_text' => '',
				    'echo' => true,
				    'field_params' => array(
					'std' => esc_html($wp_rem_cs_price_table_element_title_color),
					'id' => 'wp_rem_cs_price_table_element_title_color',
					'cust_name' => 'wp_rem_cs_price_table_element_title_color[]',
					'classes' => 'bg_color',
					'return' => true,
				    ),
				);
				...
				$wp_rem_cs_opt_array = array(
				    ...
				    'echo' => true,
				    'field_params' => array(
					'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_price_table_subtitle_color),
					'cust_name' => 'wp_rem_cs_var_price_table_subtitle_color[]',
					'classes' => 'bg_color',
					'return' => true,
				    ),
				);
				...
				$wp_rem_opt_array = array(
				    ...
				    'echo' => true,
				    'field_params' => array(
					'std' => $wp_rem_var_price_table_seperator_style,
					'id' => '',
					'cust_name' => 'wp_rem_var_price_table_seperator_style[]',
				...
				foreach ($atts_content as $price_table) {
					...
					<script type="text/javascript">
					    ...
					    function price_table_button_link<?php echo absint($rand_string); ?>($price_table_image_icon_switcher) {
						if ($price_table_image_icon_switcher != '') {
						    jQuery('.price-table-link-field-<?php echo absint($rand_string); ?>').hide();
						} else {
						    jQuery('.price-table-link-field-<?php echo absint($rand_string); ?>').show();
						}
					    }
					</script>
					<?php
...
//						'extra_atr' => 'onchange="price_table_button_link' . $rand_string . '(this.value)"',
...
//					$wp_rem_cs_var_html_fields->wp_rem_cs_var_select_field($wp_rem_opt_array);
					...
					$link_field_display = 'style="display:block;"';
					$icon_field_display = 'style="display:none;"';
					echo '<div class="price-table-link-field-' . $rand_string . '" ' . $link_field_display . '>';
					$wp_rem_cs_opt_array = array(
...
if (!function_exists('wp_rem_cs_save_page_builder_data_price_table_callback')) {
	...
	if ($widget_type == "price_table" || $widget_type == "cs_price_table") {
		...
		if (isset($data['price_table_num'][$counters['wp_rem_cs_counter_price_table']]) && $data['price_table_num'][$counters['wp_rem_cs_counter_price_table']] > 0) {
			...
			if (isset($data['wp_rem_var_price_table_seperator_style'][$counters['wp_rem_cs_counter_price_table_node']]) && $data['wp_rem_var_price_table_seperator_style'][$counters['wp_rem_cs_counter_price_table_node']] != '') {
			    $shortcode_item .= 'wp_rem_var_price_table_seperator_style="' . htmlspecialchars($data['wp_rem_var_price_table_seperator_style'][$counters['wp_rem_cs_counter_price_table_node']], ENT_QUOTES) . '" ';
			}
		...
		if (isset($data['wp_rem_cs_price_table_element_title_color'][$counters['wp_rem_cs_counter_price_table']]) && $data['wp_rem_cs_price_table_element_title_color'][$counters['wp_rem_cs_counter_price_table']] != '') {
		    $section_title .= 'wp_rem_cs_price_table_element_title_color="' . htmlspecialchars($data['wp_rem_cs_price_table_element_title_color'][$counters['wp_rem_cs_counter_price_table']], ENT_QUOTES) . '" ';
		}
		if (isset($data['wp_rem_cs_var_price_table_subtitle_color'][$counters['wp_rem_cs_counter_price_table']]) && $data['wp_rem_cs_var_price_table_subtitle_color'][$counters['wp_rem_cs_counter_price_table']] != '') {
		    $section_title .= 'wp_rem_cs_var_price_table_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_price_table_subtitle_color'][$counters['wp_rem_cs_counter_price_table']], ENT_QUOTES) . '" ';
		}
		if (isset($data['wp_rem_var_price_table_seperator_style'][$counters['wp_rem_cs_counter_price_table']]) && $data['wp_rem_var_price_table_seperator_style'][$counters['wp_rem_cs_counter_price_table']] != '') {
		    $section_title .= 'wp_rem_var_price_table_seperator_style="' . htmlspecialchars($data['wp_rem_var_price_table_seperator_style'][$counters['wp_rem_cs_counter_price_table']], ENT_QUOTES) . '" ';
		}
		...
		$section_title = apply_filters('wp_rem_shortcode_default_atts_save', $section_title, $data, $counters['wp_rem_cs_counter_price_table'], array('responsive_atts' => true));
...
if (!function_exists('wp_rem_cs_shortcode_sub_element_ui_price_table_callback')) {
	...
	if ($type == 'price_table') {
		...
		?>
	        <script type="text/javascript">
	    	function price_table_image_icon<?php echo absint($rand_id); ?>($price_table_image_icon_switcher) {
	    	    if ($price_table_image_icon_switcher == 'image') {
	    		jQuery('.price-table-image-field-<?php echo absint($rand_id); ?>').show();
	    		jQuery('.wp_rem_cs_price_table_icon_<?php echo absint($rand_id); ?>').hide();
	    	    } else {
	    		jQuery('.price-table-image-field-<?php echo absint($rand_id); ?>').hide();
	    		jQuery('.wp_rem_cs_price_table_icon_<?php echo absint($rand_id); ?>').show();
	    	    }
	    	}
	        </script>
		<?php
		$wp_rem_cs_opt_array = array(
			...
			'cust_name' => 'wp_rem_cs_price_table_image_icon[]',
			'classes' => 'chosen-select-no-single',
			'extra_atr' => 'onchange="price_table_image_icon' . $rand_id . '(this.value)"',
			'options' => array(
			    'image' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_image_field'),
			    'icon' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_price_table_icon'),
			),
		...
		$image_field_display = 'style="display:block;"';
		$icon_field_display = 'style="display:none;"';
		echo '<div class="price-table-image-field-' . $rand_id . '" ' . $image_field_display . '>';
		$wp_rem_cs_opt_array = array(
		    'std' => $wp_rem_cs_var_price_table_image,
		    'id' => 'price_table_image_array',
		    'main_id' => 'price_table_image_array',
		...
		echo '</div>';
		?>
	        <div class="form-elements wp_rem_cs_price_table_icon_<?php echo esc_attr($rand_id); ?>" <?php echo $icon_field_display; ?>>
	    	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
	    	    <label><?php echo esc_html(wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_price_table_icon')); ?></label>
			<?php
			if (function_exists('wp_rem_cs_var_tooltip_helptext')) {
	    	...
	    	<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
			<?php echo apply_filters('cs_icons_fields', '', esc_attr($rand_id), 'wp_rem_cs_price_table_icon_box', 'default'); ?>
	    	</div>
	        </div>
		<?php
		$wp_rem_cs_opt_array = array(
