...
if ( ! function_exists('wp_rem_cs_var_page_builder_accordion') ) {
    ...
    function wp_rem_cs_var_page_builder_accordion($die = 0) {
        ...
        $defaults = array(
            ...
            'wp_rem_cs_var_accordion_title_color' => '',
            'wp_rem_cs_var_accordion_subtitle_color' => '',
            'wp_rem_var_accordion_seperator_style' => '',
        );
                        ...
                        <div id="shortcode-item-<?php echo wp_rem_cs_allow_special_char($wp_rem_cs_counter); ?>" data-shortcode-template="{{child_shortcode}}[/<?php echo esc_attr('wp_rem_cs_accordion'); ?>]" data-shortcode-child-template="[<?php echo esc_attr('accordion_item'); ?> {{attributes}}] {{content}} [/<?php echo esc_attr('accordion_item'); ?>]">
                            <div class="cs-wrapp-clone cs-shortcode-wrapp cs-disable-true cs-pbwp-content" data-template="[<?php echo esc_attr('wp_rem_cs_accordion'); ?> {{attributes}}]">
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_accordion_title_color),
                                        'cust_name' => 'wp_rem_cs_var_accordion_title_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_accordion_subtitle_color),
                                        'cust_name' => 'wp_rem_cs_var_accordion_subtitle_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => $wp_rem_var_accordion_seperator_style,
                                        'id' => '',
                                        'cust_name' => 'wp_rem_var_accordion_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_accordion_callback($args) {
        ...
        if ( $widget_type == "accordion" || $widget_type == "cs_accordion" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_cs_var_accordion_title_color'][$counters['wp_rem_cs_counter_accordion']]) && $data['wp_rem_cs_var_accordion_title_color'][$counters['wp_rem_cs_counter_accordion']] != '' ) {
                    $section_title .= 'wp_rem_cs_var_accordion_title_color="' . htmlspecialchars($data['wp_rem_cs_var_accordion_title_color'][$counters['wp_rem_cs_counter_accordion']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_cs_var_accordion_subtitle_color'][$counters['wp_rem_cs_counter_accordion']]) && $data['wp_rem_cs_var_accordion_subtitle_color'][$counters['wp_rem_cs_counter_accordion']] != '' ) {
                    $section_title .= 'wp_rem_cs_var_accordion_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_accordion_subtitle_color'][$counters['wp_rem_cs_counter_accordion']], ENT_QUOTES) . '" ';
                }
                ...
                if ( isset($data['wp_rem_var_accordion_seperator_style'][$counters['wp_rem_cs_counter_accordion']]) && $data['wp_rem_var_accordion_seperator_style'][$counters['wp_rem_cs_counter_accordion']] != '' ) {
                    $section_title .= 'wp_rem_var_accordion_seperator_style="' . htmlspecialchars($data['wp_rem_var_accordion_seperator_style'][$counters['wp_rem_cs_counter_accordion']], ENT_QUOTES) . '" ';
                }
                ...
                $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $section_title, $data, $counters['wp_rem_cs_counter_accordion'], array( 'responsive_atts' => true ));
