...
if ( ! function_exists('wp_rem_cs_var_page_builder_counter') ) {
    ...
    function wp_rem_cs_var_page_builder_counter($die = 0) {
        ...
        $defaults = array(
            ...
            'wp_rem_cs_var_counter_title_color' => '',
            'wp_rem_cs_var_counter_subtitle_color' => '',
            'wp_rem_var_counter_seperator_style' => '',
        );
...
$defaults = apply_filters('wp_rem_shortcode_default_atts', $defaults, array('responsive_atts' => true));
        ...
        $wp_rem_cs_var_counter_title_color = isset($wp_rem_cs_var_counter_title_color) ? $wp_rem_cs_var_counter_title_color : '';
        $wp_rem_cs_var_counter_subtitle_color = isset($wp_rem_cs_var_counter_subtitle_color) ? $wp_rem_cs_var_counter_subtitle_color : '';
                        ...
                        <div id="shortcode-item-<?php echo wp_rem_cs_allow_special_char($wp_rem_cs_counter); ?>" data-shortcode-template="{{child_shortcode}} [/counter]" data-shortcode-child-template="[multiple_counter_item {{attributes}}] {{content}} [/multiple_counter_item]">
                            <div class="cs-wrapp-clone cs-shortcode-wrapp cs-disable-true cs-pbwp-content" data-template="[counter {{attributes}}]">
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_counter_title_color),
                                        'cust_name' => 'wp_rem_cs_var_counter_title_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_counter_subtitle_color),
                                        'cust_name' => 'wp_rem_cs_var_counter_subtitle_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => $wp_rem_var_counter_seperator_style,
                                        'id' => '',
                                        'cust_name' => 'wp_rem_var_counter_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_counter_callback($args) {
        ...
        if ( $widget_type == "counter" || $widget_type == "cs_counter" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_cs_var_counter_title_color'][$counters['wp_rem_cs_counter_counter']]) && $data['wp_rem_cs_var_counter_title_color'][$counters['wp_rem_cs_counter_counter']] != '' ) {
                    $section_title .= 'wp_rem_cs_var_counter_title_color="' . htmlspecialchars($data['wp_rem_cs_var_counter_title_color'][$counters['wp_rem_cs_counter_counter']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_cs_var_counter_subtitle_color'][$counters['wp_rem_cs_counter_counter']]) && $data['wp_rem_cs_var_counter_subtitle_color'][$counters['wp_rem_cs_counter_counter']] != '' ) {
                    $section_title .= 'wp_rem_cs_var_counter_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_counter_subtitle_color'][$counters['wp_rem_cs_counter_counter']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_var_counter_seperator_style'][$counters['wp_rem_cs_counter_counter']]) && $data['wp_rem_var_counter_seperator_style'][$counters['wp_rem_cs_counter_counter']] != '' ) {
                    $section_title .= 'wp_rem_var_counter_seperator_style="' . htmlspecialchars($data['wp_rem_var_counter_seperator_style'][$counters['wp_rem_cs_counter_counter']], ENT_QUOTES) . '" ';
                }
                ...
                // Apply filter on default attributes Saving
                 $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $section_title, $data, $counters['wp_rem_cs_counter_counter'], array( 'responsive_atts' => true ));
