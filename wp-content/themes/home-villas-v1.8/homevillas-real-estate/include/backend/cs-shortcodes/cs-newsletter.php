                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_cs_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_newsletter_title_color),
                                    'cust_name' => 'wp_rem_cs_var_newsletter_title_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_cs_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_newsletter_subtitle_color),
                                    'cust_name' => 'wp_rem_cs_var_newsletter_subtitle_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_var_newsletter_seperator_style,
                                    'id' => '',
                                    'cust_name' => 'wp_rem_var_newsletter_seperator_style[]',
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'field_params' => array(
                                    ...
                                    'options' => array(
                                        ...
                                        'fancy' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_edit_newsletter_styles_fancy'),
                                    ),
                                    'return' => true,
                                ),
                            );
    ...
    function wp_rem_cs_save_page_builder_data_newsletter_callback($args) {
        ...
        if ( $widget_type == "newsletter" || $widget_type == "cs_newsletter" ) {
            ...
            if ( isset($_POST['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $_POST['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($_POST['wp_rem_cs_var_newsletter_title_color'][$counters['wp_rem_cs_counter_newsletter']]) && $_POST['wp_rem_cs_var_newsletter_title_color'][$counters['wp_rem_cs_counter_newsletter']] != '' ) {
                    $shortcode .='wp_rem_cs_var_newsletter_title_color="' . htmlspecialchars($_POST['wp_rem_cs_var_newsletter_title_color'][$counters['wp_rem_cs_counter_newsletter']], ENT_QUOTES) . '" ';
                }
                if ( isset($_POST['wp_rem_cs_var_newsletter_subtitle_color'][$counters['wp_rem_cs_counter_newsletter']]) && $_POST['wp_rem_cs_var_newsletter_subtitle_color'][$counters['wp_rem_cs_counter_newsletter']] != '' ) {
                    $shortcode .='wp_rem_cs_var_newsletter_subtitle_color="' . htmlspecialchars($_POST['wp_rem_cs_var_newsletter_subtitle_color'][$counters['wp_rem_cs_counter_newsletter']], ENT_QUOTES) . '" ';
                }
                if ( isset($_POST['wp_rem_var_newsletter_seperator_style'][$counters['wp_rem_cs_counter_newsletter']]) && $_POST['wp_rem_var_newsletter_seperator_style'][$counters['wp_rem_cs_counter_newsletter']] != '' ) {
                    $shortcode .='wp_rem_var_newsletter_seperator_style="' . htmlspecialchars($_POST['wp_rem_var_newsletter_seperator_style'][$counters['wp_rem_cs_counter_newsletter']], ENT_QUOTES) . '" ';
                }
                ...
                if ( isset($_POST['wp_rem_var_newsletter_align'][$counters['wp_rem_cs_counter_newsletter']]) && $_POST['wp_rem_var_newsletter_align'][$counters['wp_rem_cs_counter_newsletter']] != '' ) {
                 ...
                 $shortcodee = apply_filters('wp_rem_shortcode_default_atts_save', $shortcode, $data, $counters['wp_rem_cs_counter_newsletter'], array( 'responsive_atts' => true ));
