    ...
    function wp_rem_cs_var_page_builder_promobox($die = 0) {
        ...
        if (function_exists('wp_rem_cs_shortcode_names')) {
            ...
            $defaults = array(
                ...
                'wp_rem_cs_var_email' => '',
                 'wp_rem_cs_var_promobox_title_color'=>'',
    'wp_rem_cs_var_promobox_subtitle_color'=>'',
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_promobox_title_color),
                                        'cust_name' => 'wp_rem_cs_var_promobox_title_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_promobox_subtitle_color),
                                        'cust_name' => 'wp_rem_cs_var_promobox_subtitle_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
    ...
    function wp_rem_cs_save_page_builder_data_promobox_callback($args) {
        ...
        if ($widget_type == "promobox" || $widget_type == "cs_promobox") {
            ...
            if (isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode') {
                ...
                if (isset($data['wp_rem_var_newsletter_seperator_style'][$counters['wp_rem_cs_counter_promobox']]) && $data['wp_rem_var_newsletter_seperator_style'][$counters['wp_rem_cs_counter_promobox']] != '') {
                    $wp_rem_cs_var_promobox .= 'wp_rem_var_newsletter_seperator_style="' . htmlspecialchars($data['wp_rem_var_newsletter_seperator_style'][$counters['wp_rem_cs_counter_promobox']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_cs_var_promobox_title_color'][$counters['wp_rem_cs_counter_promobox']]) && $data['wp_rem_cs_var_promobox_title_color'][$counters['wp_rem_cs_counter_promobox']] != '') {
                    $wp_rem_cs_var_promobox .= 'wp_rem_cs_var_promobox_title_color="' . htmlspecialchars($data['wp_rem_cs_var_promobox_title_color'][$counters['wp_rem_cs_counter_promobox']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_cs_var_promobox_subtitle_color'][$counters['wp_rem_cs_counter_promobox']]) && $data['wp_rem_cs_var_promobox_subtitle_color'][$counters['wp_rem_cs_counter_promobox']] != '') {
                    $wp_rem_cs_var_promobox .= 'wp_rem_cs_var_promobox_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_promobox_subtitle_color'][$counters['wp_rem_cs_counter_promobox']], ENT_QUOTES) . '" ';
                } 
                ...
                $wp_rem_cs_var_promoboxx = apply_filters('wp_rem_shortcode_default_atts_save', $wp_rem_cs_var_promobox, $data, $counters['wp_rem_cs_counter_accordion'], array( 'responsive_atts' => true ));
                
                $wp_rem_cs_var_promobox = $wp_rem_cs_var_promoboxx;
                $wp_rem_cs_var_promobox .= ']';
