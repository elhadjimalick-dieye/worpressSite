    ...
    function wp_rem_cs_var_page_builder_list($die = 0) {
        ...
        $defaults = array(
            ...
            'wp_rem_cs_var_list_item_icon_color' => '',
             'wp_rem_cs_var_list_title_color'=>'',
            'wp_rem_cs_var_list_subtitle_color'=>'',
            'wp_rem_cs_var_list_item_icon_bg_color' => '',
             'wp_rem_var_list_seperator_style'=> '',
        );
        ...
        <div id="<?php echo wp_rem_cs_allow_special_char($name . $wp_rem_cs_counter) ?>_del" class="column  parentdelete <?php echo wp_rem_cs_allow_special_char($coloumn_class); ?> <?php echo wp_rem_cs_allow_special_char($shortcode_view); ?>" item="list" data="<?php echo wp_rem_cs_element_size_data_array_index($list_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo wp_rem_cs_allow_special_char($wp_rem_cs_counter) ?> <?php echo wp_rem_cs_allow_special_char($shortcode_element); ?>" id="<?php echo wp_rem_cs_allow_special_char($name . $wp_rem_cs_counter) ?>" style="display: none;">
                ...
                <div class="cs-clone-append cs-pbwp-content">
                        ...
                        <div id="shortcode-item-<?php echo wp_rem_cs_allow_special_char($wp_rem_cs_counter); ?>" data-shortcode-template="{{child_shortcode}} [/wp_rem_cs_list]" data-shortcode-child-template="[wp_rem_cs_list_item {{attributes}}] {{content}} [/wp_rem_cs_list_item]">
                            <div class="cs-wrapp-clone cs-shortcode-wrapp cs-disable-true cs-pbwp-content" data-template="[wp_rem_cs_list {{attributes}}]">
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_list_title_color),
                                        'cust_name' => 'wp_rem_cs_var_list_title_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_list_subtitle_color),
                                        'cust_name' => 'wp_rem_cs_var_list_subtitle_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                    ...
                    'echo' => true,
                    'field_params' => array(
                        'std' => $wp_rem_var_list_seperator_style,
                        'id' => '',
                        'cust_name' => 'wp_rem_var_list_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_list_callback($args) {
        ...
        if ($widget_type == "list" || $widget_type == "cs_list") {
            ...
            if (isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode') {
                ...
                if (isset($data['wp_rem_var_list_seperator_style'][$counters['wp_rem_cs_counter_list']]) && $data['wp_rem_var_list_seperator_style'][$counters['wp_rem_cs_counter_list']] != '') {
                    $section_title .= 'wp_rem_var_list_seperator_style="' . htmlspecialchars($data['wp_rem_var_list_seperator_style'][$counters['wp_rem_cs_counter_list']], ENT_QUOTES) . '" ';
                }
                ...
                if (isset($data['wp_rem_cs_var_list_title_color'][$counters['wp_rem_cs_counter_list']]) && $data['wp_rem_cs_var_list_title_color'][$counters['wp_rem_cs_counter_list']] != '') {
                    $section_title .= 'wp_rem_cs_var_list_title_color="' . htmlspecialchars($data['wp_rem_cs_var_list_title_color'][$counters['wp_rem_cs_counter_list']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_cs_var_list_subtitle_color'][$counters['wp_rem_cs_counter_list']]) && $data['wp_rem_cs_var_list_subtitle_color'][$counters['wp_rem_cs_counter_list']] != '') {
                    $section_title .= 'wp_rem_cs_var_list_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_list_subtitle_color'][$counters['wp_rem_cs_counter_list']], ENT_QUOTES) . '" ';
                }
                ...
                if (isset($data['wp_rem_cs_var_list_item_icon_bg_color'][$counters['wp_rem_cs_counter_list']]) && $data['wp_rem_cs_var_list_item_icon_bg_color'][$counters['wp_rem_cs_counter_list']] != '') {
                  ...
                  // Apply filter on default attributes Saving
                    $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $section_title, $data, $counters['wp_rem_cs_counter_list'], array( 'responsive_atts' => true ));
