...
if (!function_exists('wp_rem_cs_var_page_builder_quote')) {
    ...
    function wp_rem_cs_var_page_builder_quote($die = 0) {
        ...
        $defaults = array(
            ...
            'wp_rem_cs_var_quote_title_color'=>'',
            'wp_rem_cs_var_quote_subtitle_color'=>'',
            'wp_rem_var_quote_seperator_style'=> '',
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        ...
                        $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_quote_title_color),
                                        'cust_name' => 'wp_rem_cs_var_quote_title_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_quote_subtitle_color),
                                        'cust_name' => 'wp_rem_cs_var_quote_subtitle_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                    ...
                    'echo' => true,
                    'field_params' => array(
                        'std' => $wp_rem_var_quote_seperator_style,
                        'id' => '',
                        'cust_name' => 'wp_rem_var_quote_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_quote_callback($args) {
        ...
        if ($widget_type == "quote" || $widget_type == "cs_quote") {
            ...
            if (isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode') {
                ...
                if (isset($data['wp_rem_cs_var_quote_title_color'][$counters['wp_rem_cs_counter_quote']]) && $data['wp_rem_cs_var_quote_title_color'][$counters['wp_rem_cs_counter_quote']] != '') {
                    $shortcode .= 'wp_rem_cs_var_quote_title_color="' . stripslashes(htmlspecialchars(($data['wp_rem_cs_var_quote_title_color'][$counters['wp_rem_cs_counter_quote']]), ENT_QUOTES)) . '" ';
                }
                if (isset($data['wp_rem_cs_var_quote_subtitle_color'][$counters['wp_rem_cs_counter_quote']]) && $data['wp_rem_cs_var_quote_subtitle_color'][$counters['wp_rem_cs_counter_quote']] != '') {
                    $shortcode .= 'wp_rem_cs_var_quote_subtitle_color="' . stripslashes(htmlspecialchars(($data['wp_rem_cs_var_quote_subtitle_color'][$counters['wp_rem_cs_counter_quote']]), ENT_QUOTES)) . '" ';
                }
                ...
                if (isset($data['wp_rem_var_quote_seperator_style'][$counters['wp_rem_cs_counter_quote']]) && $data['wp_rem_var_quote_seperator_style'][$counters['wp_rem_cs_counter_quote']] != '') {
                    $shortcode .= 'wp_rem_var_quote_seperator_style="' . htmlspecialchars($data['wp_rem_var_quote_seperator_style'][$counters['wp_rem_cs_counter_quote']], ENT_QUOTES) . '" ';
                }
                
                  // Apply filter on default attributes Saving
  $shortcodee = apply_filters('wp_rem_shortcode_default_atts_save', $shortcode, $data, $counters['wp_rem_cs_counter_accordion'], array( 'responsive_atts' => true ));
