    ...
    function wp_rem_cs_var_page_builder_flex_column($die = 0) {
        ...
        if ( function_exists('wp_rem_cs_shortcode_names') ) {
            ...
            $defaults = array(
                ...
                'wp_rem_cs_var_column_subtitle_color' => '',
                'wp_rem_var_column_seperator_style'=> '',
            );
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_cs_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_column_subtitle_color),
                                    'cust_name' => 'wp_rem_cs_var_column_subtitle_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_var_column_seperator_style,
                                    'id' => '',
                                    'cust_name' => 'wp_rem_var_column_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_flex_column_callback($args) {
        ...
        if ( $widget_type == "flex_column" || $widget_type == "cs_flex_column" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_cs_var_column_subtitle_color'][$counters['wp_rem_cs_counter_column']]) && $data['wp_rem_cs_var_column_subtitle_color'][$counters['wp_rem_cs_counter_column']] != '' ) {
                    $shortcode .= 'wp_rem_cs_var_column_subtitle_color="' . stripslashes(htmlspecialchars(($data['wp_rem_cs_var_column_subtitle_color'][$counters['wp_rem_cs_counter_column']]), ENT_QUOTES)) . '" ';
                }
                if ( isset($data['wp_rem_var_column_seperator_style'][$counters['wp_rem_cs_counter_column']]) && $data['wp_rem_var_column_seperator_style'][$counters['wp_rem_cs_counter_column']] != '' ) {
                    $shortcode .= 'wp_rem_var_column_seperator_style="' . stripslashes(htmlspecialchars(($data['wp_rem_var_column_seperator_style'][$counters['wp_rem_cs_counter_column']]), ENT_QUOTES)) . '" ';
                }
                ...
                $shortcodee = apply_filters('wp_rem_shortcode_default_atts_save', $shortcode, $data, $counters['wp_rem_cs_counter_column'], array( 'responsive_atts' => true ));
