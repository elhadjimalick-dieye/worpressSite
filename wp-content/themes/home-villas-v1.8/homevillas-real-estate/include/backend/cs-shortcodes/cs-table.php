...
if (!function_exists('wp_rem_cs_var_page_builder_table')) {
    ...
    function wp_rem_cs_var_page_builder_table($die = 0) {
        ...
        $defaults = array(
            ...
            'wp_rem_cs_var_table_title_color'=>'',
            'wp_rem_cs_var_table_subtitle_color'=>'',
            'wp_rem_var_table_seperator_style'=> '',
        );
        ...
        <div id="<?php echo esc_attr($name . $wp_rem_cs_counter); ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="table" data="<?php echo wp_rem_cs_element_size_data_array_index($table_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo esc_attr($wp_rem_cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $wp_rem_cs_counter) ?>"  data-shortcode-template="[wp_rem_cs_table {{attributes}}] {{content}} [/wp_rem_cs_table]"  style="display: none;">
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content">
                        ...
                        $wp_rem_cs_var_html_fields->wp_rem_cs_var_select_field($wp_rem_opt_array);
                         ...
                         $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_table_title_color),
                                        'cust_name' => 'wp_rem_cs_var_table_title_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                                ...
                                $wp_rem_cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_table_subtitle_color),
                                        'cust_name' => 'wp_rem_cs_var_table_subtitle_color[]',
                                        'classes' => 'bg_color',
                                        'return' => true,
                                    ),
                                );
                    ...
                    'echo' => true,
                    'field_params' => array(
                        'std' => $wp_rem_var_table_seperator_style,
                        'id' => '',
                        'cust_name' => 'wp_rem_var_table_seperator_style[]',
    ...
    function wp_rem_cs_save_page_builder_data_table_callback($args) {
        ...
        if ($widget_type == "table" || $widget_type == "cs_table") {
            ...
            if (isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode') {
                ...
                if (isset($data['wp_rem_var_table_seperator_style'][$counters['wp_rem_cs_counter_table']]) && $data['wp_rem_var_table_seperator_style'][$counters['wp_rem_cs_counter_table']] != '') {
                    $shortcode .= ' wp_rem_var_table_seperator_style="' . htmlspecialchars($data['wp_rem_var_table_seperator_style'][$counters['wp_rem_cs_counter_table']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_cs_var_table_title_color'][$counters['wp_rem_cs_counter_table']]) && $data['wp_rem_cs_var_table_title_color'][$counters['wp_rem_cs_counter_table']] != '') {
                    $shortcode .= ' wp_rem_cs_var_table_title_color="' . htmlspecialchars($data['wp_rem_cs_var_table_title_color'][$counters['wp_rem_cs_counter_table']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_cs_var_table_subtitle_color'][$counters['wp_rem_cs_counter_table']]) && $data['wp_rem_cs_var_table_subtitle_color'][$counters['wp_rem_cs_counter_table']] != '') {
                    $shortcode .= ' wp_rem_cs_var_table_subtitle_color="' . htmlspecialchars($data['wp_rem_cs_var_table_subtitle_color'][$counters['wp_rem_cs_counter_table']], ENT_QUOTES) . '" ';
                }
                // Apply filter on default attributes Saving
                $shortcodee = apply_filters('wp_rem_shortcode_default_atts_save', $shortcode, $data, $counters['wp_rem_cs_counter_table'], array( 'responsive_atts' => true ));
