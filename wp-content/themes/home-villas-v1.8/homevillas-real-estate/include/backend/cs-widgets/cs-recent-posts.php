...
class Wp_rem_cs_recentposts extends WP_Widget {
	...
	$showcount = isset($instance['showcount']) ? esc_attr($instance['showcount']) : '';
        $post_title_length = isset($instance['post_title_length']) ? esc_attr($instance['post_title_length']) : '';
	...
	$wp_rem_cs_var_html_fields->wp_rem_cs_var_text_field($wp_rem_cs_opt_array);
        ...
        $wp_rem_cs_opt_array = array(
	    'name' => wp_rem_cs_var_theme_text_srt('wp_rem_cs_var_widget_recent_post_length'),
	    'desc' => '',
	    'hint_text' => '',
	    'echo' => true,
	    'field_params' => array(
		'std' => esc_attr($post_title_length),
		'id' => wp_rem_cs_allow_special_char($this->get_field_id('post_title_length')),
		'classes' => '',
		'cust_id' => wp_rem_cs_allow_special_char($this->get_field_name('post_title_length')),
		'cust_name' => wp_rem_cs_allow_special_char($this->get_field_name('post_title_length')),
		'return' => true,
		'required' => false
	    ),
	);
	...
	$showcount = empty($instance['showcount']) ? ' ' : apply_filters('widget_title', $instance['showcount']);
        $post_title_length =  isset($instance['post_title_length']) ? $instance['post_title_length'] : '5';
	...
	if ($custom_query2->have_posts() <> "") {
		...
		<li>
			...
			<h6><a href="<?php echo esc_url(get_permalink()); ?>"><?php echo wp_trim_words(get_the_title(),$post_title_length); ?></a></h6>
