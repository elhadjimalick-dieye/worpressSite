...
if ( ! class_exists('Wp_rem_contact') ) {
    ...
    class Wp_rem_contact extends WP_Widget {
        ...
        function form($instance) {
            ...
            $wp_rem_opt_array = array(
                'name' => wp_rem_cs_var_theme_text_srt('wp_rem_var_widget_contact_fax'),
                'desc' => '',
                'hint_text' => '',
                'echo' => true,
                'field_params' => array(
                    'std' => esc_attr($fax),
                    'classes' => '',
                    'cust_id' => wp_rem_cs_allow_special_char($this->get_field_name('fax')),
                    'cust_name' => wp_rem_cs_allow_special_char($this->get_field_name('fax')),
                    'return' => true,
                    'required' => false,
                ),
            );
        ...
        function update($new_instance, $old_instance) {
            ...
            $instance['fax'] = esc_sql($new_instance['fax']);
            return $instance;
        }
