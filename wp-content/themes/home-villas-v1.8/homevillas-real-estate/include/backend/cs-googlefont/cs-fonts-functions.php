...
if ( ! function_exists('wp_rem_cs_var_get_font_att_array') ) {
	...
	function wp_rem_cs_var_get_font_att_array($atts = array()) {
		...
		if ( sizeof($atts) == 1 && is_numeric($atts[0]) )
			$atts = array_merge(array( 'normal' ), $atts);
		$r_att = '';
		foreach ( $atts as $att ) {
			$r_att .= $att . ' ';
		}
...
if ( ! function_exists('wp_rem_cs_var_custom_font_name') ) {
	...
	function wp_rem_cs_var_custom_font_name( $key = '' ) {
		...
		if( $key != '' ){
			...
			if( $content_font_type == 'custom_fonts' && is_array($wp_rem_selected_custom_fonts) && !empty($wp_rem_selected_custom_fonts)){
				...
				if( $custom_content_font_key != '' ){
					$font_name = isset($wp_rem_selected_custom_fonts['name'][$custom_content_font_key]) ? $wp_rem_selected_custom_fonts['name'][$custom_content_font_key] : '';
					if( $font_name != '' ){
	...
	function wp_rem_cs_var_load_custom_fonts( $key = '' ) {
		...
		if( $key != '' ){
			...
			if( $content_font_type == 'custom_fonts' && is_array($wp_rem_selected_custom_fonts) && !empty($wp_rem_selected_custom_fonts)){
				...
				if( $custom_content_font_key != '' ){
					$font_name = isset($wp_rem_selected_custom_fonts['name'][$custom_content_font_key]) ? $wp_rem_selected_custom_fonts['name'][$custom_content_font_key] : '';
					$font_woff = isset($wp_rem_selected_custom_fonts['woff'][$custom_content_font_key]) ? $wp_rem_selected_custom_fonts['woff'][$custom_content_font_key] : '';
					$font_ttf = isset($wp_rem_selected_custom_fonts['ttf'][$custom_content_font_key]) ? $wp_rem_selected_custom_fonts['ttf'][$custom_content_font_key] : '';
					$font_svg = isset($wp_rem_selected_custom_fonts['svg'][$custom_content_font_key]) ? $wp_rem_selected_custom_fonts['svg'][$custom_content_font_key] : '';
					$font_eot = isset($wp_rem_selected_custom_fonts['eot'][$custom_content_font_key]) ? $wp_rem_selected_custom_fonts['eot'][$custom_content_font_key] : '';
					...
					if (( isset( $font_woff ) && $font_woff != '' ) && ( isset( $font_ttf ) && $font_ttf != '' ) && ( isset( $font_svg ) && $font_svg != '' ) && ( isset( $font_eot ) && $font_eot != '' ) ){
						...
						url('" . $font_svg . "#". $font_name ."') format('svg');
