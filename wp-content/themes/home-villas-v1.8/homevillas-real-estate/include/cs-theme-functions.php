...
if ( ! function_exists('wp_rem_cs_var_comment') ):
     ...
     * @ Post Likes Counter
     */
    if ( ! function_exists('wp_rem_post_likes_count_theme') ) {

        function wp_rem_post_likes_count_theme() {
        ...
        add_action('wp_ajax_wp_rem_post_likes_count_theme', 'wp_rem_post_likes_count_theme');
        add_action('wp_ajax_nopriv_wp_rem_post_likes_count_theme', 'wp_rem_post_likes_count_theme');
    }
    ...
    if ( ! function_exists('wp_rem_title_sub_align') ) {
        ...
        function wp_rem_title_sub_align($title, $subtitle, $align, $title_style = '', $separator = '', $subtitle_color = '') {
...
//===============================  This function controlling excerpt on front end	======================
                    ...
                    foreach ( $wp_rem_cs_var_options['wp_rem_cs_var_social_net_url'] as $val ) {
                        if ( '' !== $val ) {
                            ...
                            if ( $wp_rem_cs_var_options['wp_rem_cs_var_social_net_awesome'][$i] <> '' && isset($wp_rem_cs_var_options['wp_rem_cs_var_social_net_awesome'][$i]) ) {
								 ...
								 if ($wp_rem_cs_var_options['wp_rem_cs_var_social_net_awesome'][$i] == 'fa icon-pinterest-p'){
									 $wp_rem_cs_var_options['wp_rem_cs_var_social_net_awesome'][$i] == 'icon-pinterest';
								 }
